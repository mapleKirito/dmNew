...
public class ToPicReferenceUtil2 implements Runnable {
	...
	public ToPicReferenceUtil2(String fileRealPath, String upload,
			String savepath, String resType, HashMap paramMap, String dsname) {
		super();
