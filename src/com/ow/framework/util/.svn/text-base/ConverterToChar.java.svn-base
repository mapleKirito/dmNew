...
public class ConverterToChar {
 ...
 private static ConverterToChar chineseSpelling = new ConverterToChar();  
 public static ConverterToChar getInstance() {  
 ...
 public static String trans2PinYin(String str) {  
     return ConverterToChar.getInstance().convertAll(str);  
 } 
	 public static String getNameByChine(String name){
		 return trans2PinYin(name); 
	 }
}