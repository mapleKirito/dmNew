...
public class HtaskAppendAnswerEvent implements EventListener {
	static Logger log = Logger.getLogger("FRAMEWORK");
	private ResultData resultData;
	public HtaskAppendAnswerEvent() {
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try {
			...
			String error = DetailException.expDetail(e, HtaskAppendAnswerEvent.class);
			log.error(error);
		}
		return this.resultData;
	}
