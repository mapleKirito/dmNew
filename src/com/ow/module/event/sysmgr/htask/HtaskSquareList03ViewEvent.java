...
public class HtaskSquareList03ViewEvent implements EventListener{

	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public HtaskSquareList03ViewEvent()
	{
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try
		{
			...
			if(!htaskSquarelistavalue.equals("3") ){
			...
			paginatedData.setContextName("HtaskSquareList03");
		...
		catch (Exception e)
		{
			...
			String error = DetailException.expDetail(e, HtaskSquareList03ViewEvent.class);
			log.error(error);
		}
		return resultData;
	}
