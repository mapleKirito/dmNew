...
public class HtaskSquareList04ViewEvent implements EventListener{

	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public HtaskSquareList04ViewEvent()
	{
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try
		{
			...
			if(!htaskSquarelistavalue.equals("4") ){
			...
			paginatedData.setContextName("HtaskSquareList04");
		...
		catch (Exception e)
		{
			...
			String error = DetailException.expDetail(e, HtaskSquareList04ViewEvent.class);
			log.error(error);
		}
		return resultData;
	}
