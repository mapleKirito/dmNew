...
public class SelectTopMenuAjaxList implements EventListener{

	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public SelectTopMenuAjaxList()
	{
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		...
		{
			String error = DetailException.expDetail(e, SelectTopMenuAjaxList.class);
			log.error(error);
			throw e;
		}
	}
