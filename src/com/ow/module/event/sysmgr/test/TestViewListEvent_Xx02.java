...
public class TestViewListEvent_Xx02 implements EventListener{

	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public TestViewListEvent_Xx02()
	{
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try
		{
			...
			paginatedData.setContextName("xx02Paginated");
		...
		catch (Exception e)
		{
			...
			String error = DetailException.expDetail(e, TestViewListEvent_Xx02.class);
			log.error(error);
		}
		return resultData;
	}
