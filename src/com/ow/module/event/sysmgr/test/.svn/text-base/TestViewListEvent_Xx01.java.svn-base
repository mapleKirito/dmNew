...
public class TestViewListEvent_Xx01 implements EventListener{

	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public TestViewListEvent_Xx01()
	{
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try
		{
			...
			paginatedData.setContextName("xx01Paginated");
		...
		catch (Exception e)
		{
			...
			String error = DetailException.expDetail(e, TestViewListEvent_Xx01.class);
			log.error(error);
		}
		return resultData;
	}
