...
public class TestViewListEvent_Qt01 implements EventListener{

	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public TestViewListEvent_Qt01()
	{
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try
		{
			...
			paginatedData.setContextName("qt01Paginated");
		...
		catch (Exception e)
		{
			...
			String error = DetailException.expDetail(e, TestViewListEvent_Qt01.class);
			log.error(error);
		}
		return resultData;
	}
