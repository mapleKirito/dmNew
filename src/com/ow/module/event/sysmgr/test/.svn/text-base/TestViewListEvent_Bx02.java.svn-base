...
public class TestViewListEvent_Bx02 implements EventListener{

	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public TestViewListEvent_Bx02()
	{
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try
		{
			...
			paginatedData.setContextName("bx02Paginated");
		...
		catch (Exception e)
		{
			...
			String error = DetailException.expDetail(e, TestViewListEvent_Bx02.class);
			log.error(error);
		}
		return resultData;
	}
