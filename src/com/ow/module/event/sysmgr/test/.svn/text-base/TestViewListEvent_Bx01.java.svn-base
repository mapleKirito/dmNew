...
public class TestViewListEvent_Bx01 implements EventListener{

	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public TestViewListEvent_Bx01()
	{
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try
		{
			...
			paginatedData.setContextName("bx01Paginated");
		...
		catch (Exception e)
		{
			...
			String error = DetailException.expDetail(e, TestViewListEvent_Bx01.class);
			log.error(error);
		}
		return resultData;
	}
