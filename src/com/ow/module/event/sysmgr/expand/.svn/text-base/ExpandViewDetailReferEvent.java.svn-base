...
public class ExpandViewDetailReferEvent implements EventListener{

	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public ExpandViewDetailReferEvent()
	{
...
//			String erType = mapmap.get("erType") == null ? "" : (String)mapmap.get("erType");
			...
			String error = DetailException.expDetail(e, ExpandViewDetailReferEvent.class);
			log.error(error);
		}
		return resultData;
	}
