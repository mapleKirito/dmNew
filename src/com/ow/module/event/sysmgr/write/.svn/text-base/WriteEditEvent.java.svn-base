...
public class WriteEditEvent implements EventListener {
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try
		{
			...
			Object obj=eventExecutor.getSqlSession().update(update, paramMap);
			resultData.setIntResult(1);
		}
		catch (Exception e)
		{
			resultData.setIntResult(0);
			String error = DetailException.expDetail(e, WriteEditEvent.class);
			log.error(error);
		}
		return resultData;
	}
