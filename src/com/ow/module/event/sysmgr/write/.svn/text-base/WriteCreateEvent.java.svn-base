...
public class WriteCreateEvent implements EventListener {
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try
		{
			...
			String aCreater=paramMap.get("aUserID").toString();
			paramMap.put("aCreater", aCreater);
		...
		catch (Exception e)
		{
			...
			String error = DetailException.expDetail(e, WriteCreateEvent.class);
			log.error(error);
		}
		return resultData;
	}
