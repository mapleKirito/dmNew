...
public class HistorySeachEvent  implements EventListener{
	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public HistorySeachEvent()
	{
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try
		{
			...
			Object obj = (HashMap)eventExecutor.getSqlSession().selectOne(selectSqlId, paramMap);//陈列室
