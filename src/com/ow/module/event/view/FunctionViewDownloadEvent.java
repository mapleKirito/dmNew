...
public class FunctionViewDownloadEvent implements EventListener{

	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public FunctionViewDownloadEvent()
	{
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
        ...
        {
			/** 执行器执行失败 */
			String error = DetailException.expDetail(e, FunctionViewDownloadEvent.class);
			log.error(error);
			throw e;
        }
		return resultData;		
