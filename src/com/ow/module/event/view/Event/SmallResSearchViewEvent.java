...
public class SmallResSearchViewEvent implements EventListener{
	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public SmallResSearchViewEvent()
	{
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try
		{
			...
			if("exhibition".equals(roomtype)){
				...
				if("".equals(((HashMap)obj).get("orCateFiveLevel")) || ((HashMap)obj).get("orCateFiveLevel") == null){
					if("".equals(((HashMap)obj).get("orCateFoLevel")) || ((HashMap)obj).get("orCateFoLevel") == null){
						if("".equals(((HashMap)obj).get("orCateThLevel")) || ((HashMap)obj).get("orCateThLevel") == null){
							...
							mapmap.put("orCateThLevel", ((HashMap)obj).get("orCateThLevel"));
						}
					}else{
						mapmap.put("orCateFoLevel", ((HashMap)obj).get("orCateFoLevel"));
					}
				}else{
					mapmap.put("orCateFiveLevel", ((HashMap)obj).get("orCateFiveLevel"));
				}
			...
			if("exhibition".equals(roomtype)) {
				...
				for(HashMap<String, Object> res : list1) {
					...
					map.put("position", res.get("erProvinceName"));
					map.put("room", "1");
					list.add(map);
