...
public class ForumInitInfoListEvent implements EventListener {
	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public ForumInitInfoListEvent() {
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		...
		catch (Exception e)
		{
			...
			String error = DetailException.expDetail(e, ForumInitInfoListEvent.class);
			log.error(error);
		}
		return resultData;
	}
