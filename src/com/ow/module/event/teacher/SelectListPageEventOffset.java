...
public class SelectListPageEventOffset implements EventListener{
	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public SelectListPageEventOffset()
	{
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		...
		{
			String error = DetailException.expDetail(e, SelectListPageEventOffset.class);
			log.error(error);
			throw e;
		}
	}
