...
public class MyInfoEvent implements EventListener{
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try {
			...
			paramMap.put("taskList_count", count);//布置作业量总数
			...
			paginatedData.setContextName("taskPaginated1");
		...
		catch (Exception e)
		{
			...
			String error = DetailException.expDetail(e, MyInfoEvent.class);
			log.error(error);
		}
		return resultData;
	}
