...
public class UnFinshedTaskEvent implements EventListener{

	static Logger log = Logger.getLogger(Constant.FRAMEWORK);
	private ResultData resultData;
	public UnFinshedTaskEvent() {
	...
	public ResultData event(EventExecutor eventExecutor) throws Exception {
		try {
			...
			paginatedData.setContextName("taskPaginated3");
		...
		catch (Exception e)
		{
			...
			String error = DetailException.expDetail(e, UnFinshedTaskEvent.class);
			log.error(error);
		}
		return resultData;
	}
