				...
				if (data.returnValue == 1){
    				...
    				$.ajax({
    					...
    					success:function(jsonData,textStatus){
    						...
    						if (textStatus == "success"){
    							location.href = "decorateForwardAction.action?code=001001&"+ new Date();
    						}
    					},
  ...
  <tr>
    <td valign="top" style="padding:5px;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_1">
				...
				<td height="30">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-bottom:1px solid #cdcdcd;">
					  <tr>
				        ...
				        <td width="25%">班级学生数：<span class="font_2"> ${initMap.invitation.userCount} 人</span></td>
				        <td width="50%">未完成作业数：<span class="font_3"><a href="decorateForwardAction.action?code=002001004010"><font color="red" ><b>${initMap.invitation.taskUnfinishedCount}</b></font></a></span></td>
					  </tr>
					</table>
				</td>
			</tr>
				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_yj">
					  <tr>
				        ...
				        <a href="javascript:void(0)">已推荐</a>
				        </s:if>
				        </span>|
				        <span class="span2 font_2">
			...
			<tr>
				<td valign="top">
					<table border="0" cellspacing="0" cellpadding="0" class="table_6"  width="100%">
					  <tr>
					  ...
					  <tr>
						<td width="97" valign="top"  style="background:url(images/main/bg_17.png) no-repeat; padding:0;">
							<table width="97" border="0" cellspacing="0" cellpadding="0">
							  <tr>
								<td>
									<p align="center"><img src="images/main/toux.jpg" width="75" height="74"></p>
						...
						<td width="100%" valign="top" bgcolor="#fdfeff" >
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tr>
								...
								<div class="left"><a href="javascript:void(0)" id="${initMap.invitation.taskId}" name="tname" class="edit">编辑</a></div>
								</td>
							  </tr>
							</table>
							</s:if>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" class="table_6 margin_top1"  width="100%">
					  <tr>
					  	<th colspan="2"  height="34" >
					  ...
					  <tr>
						<td width="97" valign="top"  style="background:url(images/main/bg_17.png) no-repeat; padding:0;">
							<table width="97" border="0" cellspacing="0" cellpadding="0">
							  <tr>
								<td>
									<p align="center"><img src="images/main/toux1.jpg" width="75" height="74"></p>
						...
						<td width="100%" valign="top" bgcolor="#fdfeff" >
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tr>
								<td style="border-top:1px dashed #CCCCCC;padding-top:12px;">
                                    <div class="czuoq">
                                    	<s:if test="initMap.invitation.isLock == 0 && #invitationList.userAccount!=session.s_userLoginAccount ">
                                        <div class="left" style="width:300px;">
                                            ...
                                            <div class="left pingyu"><a href="javascript:void(0)" id="${invitationList.tiID}" class="comment">评语</a></div>
                                            <div class="left span2"><img src="images/main/bbs_4.png"></div>
                                            <div class="left"><a href="javascript:void(0)" id="${invitationList.tiID}" class="excellent">评为优秀</a></div>
                                        </div>
                                        ...
                                        <span class="span2 font_2"><a href="javascript:void(0)" class="score" name="medium" id="${invitationList.tiID}">基本满意</a></span>（${invitationList.tiGoodScorePercent}%）${invitationList.tiMediumScore} |
