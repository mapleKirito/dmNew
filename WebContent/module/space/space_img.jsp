...
<style type="text/css">
img#target {
border: 1px solid #583914;
background: none;}
table tr td span {color: #924100; font-family:"微软雅黑" ;height: 40px;line-height: 40px;}
input[type=button] {
	background: #D1BC98;
width: 75px;
height: 35px;
...
#toumodify{
background: url(<%=request.getContextPath()%>/images-ce/toumodify.png) center no-repeat;
...
<body >
<table id="toumodify" border="0" height="590" width="100%" style=" position:relative; background:url(images-ce/toumodify.png) no-repeat; background-size:100% 100%;">
<tr >
	<td>
	<div style="position: relative;">
		<table height="100%" width="100%" >
			<tr style="height: 150px;">
				<td valign="top"  style="padding: 40px;" id="jfold">
					<span>操作：</span><br/>
					<span>&lt; 1 &gt;如果
				...
				<td valign="top" align="center">
					<span style="width:150px;height:150px;overflow:hidden;position: absolute;left: 450px;border: 1px solid #583914;top: 69px;" id="jcPreview">
						<img src="<%=request.getContextPath()%>/images/old.png" id="preview" alt="Preview"  />
					</span>
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center" valign="middle" id="jcTarget" style="padding: 30px;">
