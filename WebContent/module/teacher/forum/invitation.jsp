			...
			if (data.returnValue == 1){
				$.extend(data,{returnValue:'true'});
   				...
   				$.ajax({
   					...
   					url:		'ajaxAction.action?code=002001004005&paramMap.isRecommend=${session.s_userID}&paramMap.taskId=${initMap.invitation.taskId}',
			...
			if (data.returnValue == 1){
				$.extend(data,{returnValue:'true'});
   				...
   				$.ajax({
   					...
   					url:		'ajaxAction.action?code=002001004006&paramMap.isLock=${session.s_userID}&paramMap.taskId=${initMap.invitation.taskId}',
