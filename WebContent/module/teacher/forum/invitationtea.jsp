...
$(document).ready(function(){
	$('.reply').screenTB({
		...
		buttons:'no',
		dialogType:'iframe',
		iframeSrc:'forwardAction.action?code=002006005001'
		},{
	...
	$('.quote').screenTB({
			...
			buttons:'no',
			dialogType:'iframe',
			iframeSrc:'forwardAction.action?code=002006005008'
		},{
			paramEvent:function(data,o){
			var $obj = $(o);
			var id = $obj.attr("id");
	...
	$('.edit').screenTB({
			...
			buttons:'no',
			dialogType:'iframe',
			iframeSrc:'forwardAction.action?code=002006005002'
		},{
			paramEvent:function(data,o){
			var $obj = $(o);
			var id = $obj.attr("id");
	...
	$('.comment').screenTB({
		...
		buttons:'no',
		dialogType:'iframe',
		iframeSrc:'forwardAction.action?code=002006005003'
		},{
			paramEvent:function(data,o){
				var $obj = $(o);
				var id = $obj.attr("id");
			...
			if (data.returnValue == 1){
				$.extend(data,{returnValue:'true'});
   				...
   				$.ajax({
   					...
   					url:		'ajaxAction.action?code=002006005004&paramMap.tiExcellent=1&paramMap.tiId=' + id,
			...
			if (data.returnValue == 1){
				$.extend(data,{returnValue:'true'});
   				...
   				$.ajax({
   					...
   					url:		'ajaxAction.action?code=002006005004&paramMap.tiExcellent=0&paramMap.tiId=' + id,
			...
			if (data.returnValue == 1){
				$.extend(data,{returnValue:'true'});
   				...
   				$.ajax({
   					...
   					url:		'ajaxAction.action?code=002006005005&paramMap.isRecommend=${session.s_userID}&paramMap.taskId=${initMap.invitation.taskId}',
			...
			if (data.returnValue == 1){
				$.extend(data,{returnValue:'true'});
   				...
   				$.ajax({
   					...
   					url:		'ajaxAction.action?code=002006005005&paramMap.isRecommend=0&paramMap.taskId=${initMap.invitation.taskId}',
			...
			if (data.returnValue == 1){
				$.extend(data,{returnValue:'true'});
   				$.ajax({
   					...
   					url:		'ajaxAction.action?code=002006005007&paramMap.taskId=' +tId+ '&paramMap.erID=' + resultId,
   					...
   					success:function(jsonData,textStatus){
   						...
   						if (textStatus == "success"){
   							location.href = "decorateForwardAction.action?code=002006&"+ new Date();
   						}
   					},
			...
			if (data.returnValue == 1){
				$.extend(data,{returnValue:'true'});
   				...
   				$.ajax({
   					...
   					url:		'ajaxAction.action?code=002006005006&paramMap.isLock=${session.s_userID}&paramMap.taskId=${initMap.invitation.taskId}',
			...
			if (data.returnValue == 1){
				$.extend(data,{returnValue:'true'});
   				...
   				$.ajax({
   					...
   					url:		'ajaxAction.action?code=002006005006&paramMap.isLock=0&paramMap.taskId=${initMap.invitation.taskId}',
		...
		submitEvent:function(data,$obj){
			if (data.returnValue == 1){
				...
				$.ajax({
					...
					url:		'ajaxAction.action?code=002006005009&'+param,
			...
			<tr>
				<td valign="top">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_611">
						  <tr>
						 	<td width="100%" bgcolor="#fdfeff" valign="top" class="table_1121">
								
									<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_911">
										<tr >
											<td valign="top" bgcolor="#f5f9fc">
												<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-bottom:1px solid #cdcdcd;">
												  <tr align="center" height="30">
											        ...
											        <td width="25%">未完成作业人数：<span class="font_3"><a href="decorateForwardAction.action?code=002007001&paramMap.taskId=${initMap.invitation.taskId}"><font color="red" ><b>${initMap.invitation.taskUnfinishedCount}</b></font></a></span></td>
												  </tr>
												</table>
											</td>
										</tr>
										<tr>
											<td bgcolor="#f5f9fc">
											        ...
											        <td width="32%">
											        <s:if test="(initMap.invitation.isRecommend == #session.s_userID)||(initMap.invitation.isRecommend == 0)||(#session.s_userType==3)">
											        <span class="span2 font_2">
												        ...
												        <s:elseif test="(initMap.invitation.isRecommend == #session.s_userID)||(#session.s_userType==3)">
												        ...
												        <span class="span2 font_2">
												        	...
												        	<s:if test="(initMap.invitation.isLock != #session.s_userID)&&(initMap.invitation.isLock != 0)">已锁定</s:if>
												        	<s:if test="initMap.invitation.isLock == #session.s_userID"><a href="javascript:void(0)" class="invUnlock" id="${initMap.invitation.taskId}" name="${initMap.invitation.isLock}">解锁</a></s:if>
												        </span>
												        <s:if test="initMap.invitation.isLock == 0">
										...
										<td >
											<table border="0" cellspacing="0" cellpadding="0" class="table_611_1"  width="100%" >
											  ...
											  <tr>
												...
												<td width="100%" valign="top" bgcolor="#f5f9fc" style="padding-top:10px;">
						                    ...
						                    <table border="0" cellspacing="0" cellpadding="0" class="table_611_1 margin_top1"  width="100%">
											  <tr>
											  	<th colspan="2"  height="34" >
