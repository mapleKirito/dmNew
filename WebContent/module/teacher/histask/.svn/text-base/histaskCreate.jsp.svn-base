...
function dosubmit(this_) {
	...
	if(isEmpty && checkAllTextValid(this_)){
		 isEmpty=true;
	}else{
		isEmpty=false;
	}
...
<form name="actionForm" method="post" id="actionForm" enctype="multipart/form-data"  action="uploadDataAction.action" onsubmit="return dosubmit(this);" style="border: 1px solid #A98534;border-top: none;">
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0"  bgcolor="#F8F4ED"  >
  <tr>
					  ...
					  <tr>
						<td width="100%"  valign="top">
							...
							<table id="createtable9" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_9">
							  ...
							  <tr bgcolor="#F8F4ED" >
								<td width="20%" class="tatd" align="right">问题分类：</td>
								<td width="80%" class="tatd" align="left">
							  ...
							  <tr bgcolor="#F8F4ED" height="40px;">
								<td width="20%" class="tatd" align="right">悬赏财富：</td>
