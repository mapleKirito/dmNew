...
function toxiangce(f){
    		//alert(123);
    		$("#childrenMain" , parent.document).attr("src","decorateForwardAction.action?code=002032008007&paramMap.gaParentId="+f+"&paramMap.userID=${paramMap.userID }&suijichileren="+new Date()+"&paramMap.gaShare=1");		
				...
				<ul class="groups">
					<s:iterator id="t" value="initMap.imgList" status="index">
						...
						<li class="mem_class" style="height: 160px;padding-top: 6px;" ><s:if
							...
							<p style="width: 150px; white-space: nowrap;left:30px;;position:relative; overflow: hidden; text-overflow: ellipsis;" >${(t.gaDescription)==""?"&nbsp":(t.gaDescription)}</p>
							<p style="width: 150px; left:30px;;position:relative;white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
								时间：${t.gaCreateTime }
							</p>
						</li>
						</s:if>
