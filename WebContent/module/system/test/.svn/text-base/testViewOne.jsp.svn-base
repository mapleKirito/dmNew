...
#right_title { padding: 10px; border: 1px solid #ecd2d2; background: #ffecec; color: #464646; border-radius: 3px;height: 125px;overflow: hidden; }
#right_optiones { border: 1px solid #e0e0e0; background: #f7f7f7; color: #464646; border-radius: 3px; }
...
<div class="page-container ssjh" style=" background:url(images-ce/tanjiuback.png) center bottom no-repeat; background-size:100% 100%;height: 550px;">
