...
<input type="hidden" name="code" value="002001004001">
  ...
  <tr>
    <td valign="top" style="padding:5px;">
       <div style="width:725;height:365;overflow:auto;" >
		<textarea cols="80" id="editor1" name="paramMap.tiContent" rows="10"><s:if test="initMap.contentInfo.content != null">${initMap.contentInfo.content}</s:if></textarea>
	    <script type="text/javascript">
		  CKEDITOR.replace( 'editor1', { toolbar : [ ['SelectAll'], ['Link', 'Unlink'], 
                ['Bold', 'Italic','Underline'],  ['TextColor'], ['NumberedList','BulletedList'], ['Maximize'] ] } );
		</script>
	  </div>
	</td>
  </tr>
