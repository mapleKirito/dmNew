...
<input type="hidden" name="code" value="002001004002">
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="table">
  <tr>
    <td valign="top" style="padding:5px;">
		...
		<textarea cols="80" id="editor1" name="paramMap.content" rows="10"><s:if test="initMap.contentInfo.content != null">${initMap.contentInfo.content}</s:if></textarea>
	    <script type="text/javascript">
