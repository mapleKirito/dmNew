					...
					<td>
						...
						<div class="lt-command">
						 	...
						 	<s:if test="pmsIndex.res_observation_room_welcome_manager">
						 		<a href="decorateForwardAction.action?code=${pmsIndex.res_observation_room_welcome_manager.code}" style="background: none;color: #924100;">
							...
							<s:if test="pmsIndex.res_observation_room_create">
		 						<a href="decorateForwardAction.action?code=${pmsIndex.res_observation_room_create.code}" class="fade-button" data-old-bg="rgb(124, 109, 91)" >
