...
<input type="hidden" name="paramMap.grResourceID" id="grResourceID" value="${initMap.observationInfo.orID}">
<input type="hidden" name="paramMap.grThumbnail" id="grThumbnail" value="${initMap.observationInfo.orThumbnail}">
<input type="hidden" name="paramMap.grResourceType" id="grResourceType" value="observation">
<input type="hidden" name="paramMap.grUpload" id="grUpload" value="${initMap.observationInfo.orUpload}">
<input type="hidden" name="paramMap.grType" id="grType" value="${initMap.observationInfo.orType }">
					...
					<tr class="MeNewTDLine" align="center">
						...
						<table class="Ntable" cellSpacing="1" cellPadding="0" width="100%" border="0">
							...
							<tr class="MeNewTDLine">
								...
								<td class="SkyTDLine">
									<select disabled="disabled">
										...
										<option value="observation" selected>专题研读室</option>
							...
							<tr class="MeNewTDLine">
								...
								<td class="SkyTDLine">
								<input name="paramMap.grName" type="text" maxlength="16" id="grName" style="width: 200px;" value="${initMap.observationInfo.orName}" readonly="readonly" />
								&nbsp;
