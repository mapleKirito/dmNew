...
$(document).ready(function(){	
	...
	var ujdata = {
	    	...
	    	columnDesc:{
				...
				showColumn: ['lrName','lrCategoryName','lrCreator'],
				//列表头显示名称
				...
				primkeyColumn:["lrID","lrName","lrThumbnail","lrUpload","lrType"],
				//要增加链接的列，可以为多个
				linkColumn:[{name:'',url:'',param:''}]
	    	},		
	    	ajax:{
	        	url:'ajaxAction.action',
	        	data:'code=${pmsIndex.res_laboratory_room_grade_search.code}'
		    },
		    //是否有分页工具条
		    isPagination:'true',	    
	    	paginationData:{
...
<input type="hidden" name="searchMap.lrIsGrade" id="lrIsGrade" value="0">
					...
					<td class="SkyTDLine">
						<table width="100%" border="0" cellpadding="0" cellspacing="1"
							...
							<tr align="center" class="MeNewTDLine">
								...
								<td align="left" class="SkyTDLine" width="30%">&nbsp;&nbsp;<input type="text" name="searchMap.lrName" value="${paramMap.lrName}" id="lrName" style="width: 200px;" /></td>
								<td align="center" class="SkyTDLine" width="20%">
									<s:if test="pmsIndex.res_laboratory_room_grade_search">
										<a href="javascript:void(0)" id="search_res"><img src="<%=request.getContextPath()%>/${pmsIndex.res_laboratory_room_grade_search.icon}" align="absmiddle" width="14" border="0" height="14">${pmsIndex.res_laboratory_room_grade_search.name}</a>
									</s:if>
								</td>
							</tr>
						</table></td>
