...
<input type="hidden" name="paramMap.grResourceID" id="grResourceID" value="${initMap.laboratoryInfo.lrID}">
<input type="hidden" name="paramMap.grThumbnail" id="grThumbnail" value="${initMap.laboratoryInfo.lrThumbnail}">
<input type="hidden" name="paramMap.grResourceType" id="grResourceType" value="laboratory">
<input type="hidden" name="paramMap.grUpload" id="grUpload" value="${initMap.laboratoryInfo.lrUpload}">
<input type="hidden" name="paramMap.grType" id="grType" value="${initMap.laboratoryInfo.lrType }">
					...
					<tr class="MeNewTDLine" align="center">
						...
						<table class="Ntable" cellSpacing="1" cellPadding="0" width="100%" border="0">
							...
							<tr class="MeNewTDLine">
								...
								<td class="SkyTDLine">
									<select disabled="disabled">
										...
										<option value="laboratory" selected>教学研究室</option>
							...
							<tr class="MeNewTDLine">
								...
								<td class="SkyTDLine">
								<input name="paramMap.grName" type="text" maxlength="16" id="grName" style="width: 200px;" value="${initMap.laboratoryInfo.lrName}" readonly="readonly" />
								&nbsp;
