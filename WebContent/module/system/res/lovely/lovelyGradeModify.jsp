...
<input type="hidden" name="paramMap.grResourceID" id="grResourceID" value="${initMap.expandInfo.erID}">
<input type="hidden" name="paramMap.grThumbnail" id="grThumbnail" value="${initMap.expandInfo.erThumbnail}">
<input type="hidden" name="paramMap.grResourceType" id="grResourceType" value="expand">
<input type="hidden" name="paramMap.grUpload" id="grUpload" value="${initMap.exhiInfo.erUpload}">
<input type="hidden" name="paramMap.grType" id="grType" value="${initMap.exhiInfo.erType}">
					...
					<tr class="MeNewTDLine" align="center">
						...
						<table class="Ntable" cellSpacing="1" cellPadding="0" width="100%" border="0">
							...
							<tr class="MeNewTDLine">
								...
								<td class="SkyTDLine">
									<select disabled="disabled">
										...
										<option value="expand"  selected>自主探究室</option>
									</select>
								&nbsp;
							...
							<tr class="MeNewTDLine">
								...
								<td class="SkyTDLine">
								<input name="paramMap.grName" type="text" maxlength="16" id="grName" style="width: 200px;" value="${initMap.expandInfo.erName}" readonly="readonly" />
								&nbsp;
