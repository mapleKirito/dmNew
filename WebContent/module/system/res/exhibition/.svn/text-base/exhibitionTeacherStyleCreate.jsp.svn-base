			...
			<tr>
				<td valign="top">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_6">
					  <tr>
						<td width="100%" bgcolor="#F8F4ED" valign="top">
							<div>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_9">
									...
									<tr  >
								   	...
								   	<tr  >
										<td width="15%"  height="50px" class="tatd" align="right">资源文件：</td>
								   ...
								   <%-- 	<tr >
									...
									<%-- <tr >
										...
										<td width="85%"  class="tatd" align="left">
											<textarea cols="60" id="erDescription" name="paramMap.erDescription" rows="10"></textarea>&nbsp;
									...
									<tr >
										...
										<td width="85%"  class="tatd" align="left">
											<textarea cols="60" id="erRemarks" name="paramMap.erRemarks" rows="10"></textarea>&nbsp;
...
<div class="uploadDiv" style="position:absolute;">
	...
	<form action="/dm/uploadFile/upload" id="uploadForm" enctype="multipart/form-data" method="post" target="target_upload">
		...
		<span id="enableUp" >（允许上传格式包括：.jpg、.png、gif）</span>
