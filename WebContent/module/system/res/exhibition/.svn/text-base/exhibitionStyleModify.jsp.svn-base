							...
							<div>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_9">
									...
									<tr >
										...
										<td width="75%" class="tatd" align="left"><input name="paramMap.erName" value="${initMap.exhiInfo.erName}" type="text" maxlength="180" id="erName" style="width: 200px;" />&nbsp;
									...
									<tr >
										...
										<td width="75%" class="tatd" align="left">
											...
											<font color="red">*</font><span id="erTotalIDTip" style="position:absolute;height:22px;width:115px"></span>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<tr >
										...
										<td width="75%" class="tatd" align="left">
											...
											<font color="red">*</font><img src="images/add.png" border="0" height="20px;" class="addcate"  onclick="openAddCateBox('erTotalID','erChorID','erJieID');">
											
											<span id="erJieIDTip" style="position:absolute;height:22px;width:158px"></span>
											<!-- 	&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<tr  >
								   	...
								   	<tr >
										<td width="25%" class="tatd" align="right" id="exhibition_11">保存地：</td>
										<td width="75%" class="tatd" align="left"><input name="paramMap.erBiologicalReserve" type="text" value="${initMap.exhiInfo.erBiologicalReserve}" maxlength="64" id="erBiologicalReserve" style="width: 200px;" />&nbsp;
										<span id="erBiologicalReserveTip" style="position:absolute;height:22px;width:297px"></span></td>
									</tr>
									<tr >
										<td width="25%" class="tatd" align="right">采集人：</td>
										<td width="75%" class="tatd" align="left"><input name="paramMap.erHunters" type="text" value="${initMap.exhiInfo.erHunters}" maxlength="64" id="erHunters" style="width: 200px;" />&nbsp;
										<span id="erHuntersTip" style="position:absolute;height:22px;width:297px"></span></td>
									</tr>
									<tr >
										<td width="25%" class="tatd" align="right">采集号：</td>
										<td width="75%" class="tatd" align="left"><input name="paramMap.erSpecimensNo" type="text" maxlength="16" id="erSpecimensNo" value="${initMap.exhiInfo.erSpecimensNo}" style="width: 200px;" />&nbsp;
									...
									<%-- <tr >
										...
										<td width="75%" class="tatd" align="left"><input name="paramMap.erPlaceName" type="text" value="${initMap.exhiInfo.erPlaceName}" id="erPlaceName" style="width: 200px;" />&nbsp;
									...
									<%-- <tr >
										<td width="25%" class="tatd" align="right" id="exhibition_8">生境：</td>
										<td width="75%" class="tatd" align="left"><input name="paramMap.erHabitat" type="text" value="${initMap.exhiInfo.erHabitat}" id="erHabitat" style="width: 200px;" />&nbsp;
										<span id="erHabitatTip" style="position:absolute;height:22px;width:297px"></span></td>
									</tr>
									<tr >
										<td width="25%" class="tatd" align="right" id="exhibition_9">性状：</td>
										<td width="75%" class="tatd" align="left">
									...
									<tr >
										...
										<td width="75%" class="tatd" align="left"><input name="paramMap.erElevation" type="text" value="${initMap.exhiInfo.erElevation}" maxlength="32" id="erElevation" style="width: 200px;" />&nbsp;
									...
									<tr >
										...
										<td width="75%" class="tatd" align="left"><input name="paramMap.erIdentifier" type="text" value="${initMap.exhiInfo.erIdentifier}" maxlength="64" id="erIdentifier" style="width: 200px;" />&nbsp;
									...
									<tr >
										<td width="25%" class="tatd" align="right" id="exhibition_10">用途：</td>
										<td width="75%" class="tatd" align="left"><input name="paramMap.erUse" type="text" value="${initMap.exhiInfo.erUse}" id="erUse" style="width: 200px;" />&nbsp;
		...
		<div style="margin-top: 20px;margin-left: 30px;">
			<span style="font-size: 14px;line-height: 48px;">请输入分类名称：</span>
				<span id="info" upID="" downID="" class="addcatespan">
					...
					<input class="addcateButton" type="button" value="提交" disabled="disabled"/>
