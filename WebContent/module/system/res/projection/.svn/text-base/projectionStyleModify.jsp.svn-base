								  ...
								  <tr  height="30">
									...
									<tr  height="30">
								  	...
								  	<tr >
										...
										<td width="75%" class="tatd" align="left"><input name="paramMap.prName" type="text" value="${initMap.projInfo.prName}" maxlength="180" id="prName" style="width: 200px;" />&nbsp;
									...
									<tr >
										...
										<td  class="tatd"> 
											...
											<font color="red">*</font><span id="prCategoryTip" style="position:absolute;height:22px;width:115px"></span>
									...
									<tr >
										<td width="25%" class="tatd" align="right">中学分类：</td>
										<td width="75%" class="tatd" align="left">
