...
$(document).ready(function(){	
	...
	var ujdata = {
	    	...
	    	columnDesc:{
				...
				showColumn: ['prName','prCategoryName','prCreator'],
				//列表头显示名称
				columnName:   ['影片名称','资源分类','创建人'],
				//列表头宽度
				...
				primkeyColumn:["prID","prName","prThumbnail","prUpload","prType"],
				//要增加链接的列，可以为多个
				linkColumn:[{name:'',url:'',param:''}]
	    	},		
	    	ajax:{
	        	url:'ajaxAction.action',
	        	data:'code=${pmsIndex.res_projection_room_grade_search.code}'
		    },
		    //是否有分页工具条
		    isPagination:'true',	    
	    	paginationData:{
...
<input type="hidden" name="searchMap.prIsGrade" id="prIsGrade" value="0">
					...
					<td class="SkyTDLine">
						<table width="100%" border="0" cellpadding="0" cellspacing="1"
							...
							<tr align="center" class="MeNewTDLine">
								...
								<td align="left" class="SkyTDLine" width="30%">&nbsp;&nbsp;<input type="text" name="searchMap.prName" value="${paramMap.prName}" id="prName" style="width: 200px;" /></td>
								<td align="center" class="SkyTDLine" width="20%">
									<s:if test="pmsIndex.res_projection_room_grade_search">
										<a href="javascript:void(0)" id="search_res"><img src="<%=request.getContextPath()%>/${pmsIndex.res_projection_room_grade_search.icon}" align="absmiddle" width="14" border="0" height="14">${pmsIndex.res_projection_room_grade_search.name}</a>
									</s:if>
								</td>
							</tr>
						</table></td>
