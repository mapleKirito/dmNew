		...
		success:function(jsonData,textStatus){//ajax请求成功调用函数
			if (textStatus == "success"){
				...
				for(var i=0;i<jsonData.list.length;i++){
					...
					//alert(jsonData.list[i].name);
					//alert($(".resAll_"+jsonData.list[i].id).find("a").find("img").attr("src"));
				}
...
<input type="hidden" id="userType" value="${paramMap.s_userType}">
 <div id="layout_mainbody">
 	 <div class="res-detail-info">
                    <h4 class="res_name" style="background:url(<%=request.getContextPath()%>/images-ce/detaltop.png) center bottom no-repeat; background-size:100% 100%;background-image: url('<%=request.getContextPath()%>/images-ce/detaltop.png');background-size: cover;"><b>资源名称：</b>${initMap.videoDetail.prName}</h4>
