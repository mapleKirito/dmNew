								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_9">
									...
									<tr  height="30">
								  	...
								  	<tr >
										...
										<td width="75%" class="tatd" align="left"><input name="paramMap.prName" type="text" maxlength="180" id="prName" style="width: 200px;" />&nbsp;
									...
									<tr >
										...
										<td  class="tatd"> 
											...
											<font color="red">*</font>
											<span id="prCategoryTip" style="position:absolute;height:22px;width:115px"></span>
									...
									<tr >
										...
										<td width="75%" class="tatd" align="left"><input name="paramMap.prCreateTime" type="text" class="Wdate" maxlength="10" id="prCreateTime" style="width: 200;" onFocus="WdatePicker({isShowWeek:true,dateFmt:'yyyy-MM-dd',readOnly:true});" />&nbsp;
										</td>
									</tr>
									<tr  align="center">
...
<div class="uploadDiv" style="position:absolute;">
	...
	<form action="/dm/uploadFile/upload" id="uploadForm" enctype="multipart/form-data" method="post" target="target_upload">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">*</font><span id="isUploadTip" style=" position:absolute;height:22px;width:115px"></span>
	</form>
</div>
<div id="progress">
	<div id="title">
