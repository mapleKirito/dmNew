...
$(document).ready(function(){	
 //input验证
	...
	$("#dtName").formValidator({onshow:"请输入字典类型名称",onfocus:"请输入您的字典类型名称",oncorrect:"输入正确"}).inputValidator({min:1,onerror:"字典类型名称不能为空,请确认"});
	$("#dtValue").formValidator({onshow:"请输入字典类型变量",onfocus:"请输入您的字典类型变量",oncorrect:"输入正确"}).inputValidator({min:1,onerror:"字典类型变量不能为空,请确认"});
});
...
<input type="hidden" name="paramMap.dtSort" value="1"> 
					...
					<tr class="MeNewTDLine" align="center">
						...
						<table class="Ntable" cellSpacing="1" cellPadding="0" width="100%" border="0">
							<tr class="MeNewTDLine">
								...
								<td class="SkyTDLine"><input name="paramMap.dtName" type="text" maxlength="180" id="dtName" style="width: 200px;"/>&nbsp;<font color="red">*</font><span id="dtNameTip" style="position:absolute;height:22px;width:250px"></span></td>
							</tr>
							<tr class="MeNewTDLine">
								<td align="right" class="SkyTDLine">变量名称：</td>
								<td class="SkyTDLine"><input name="paramMap.dtValue" type="text" maxlength="180" id="dtValue" style="width: 200px;"/>&nbsp;<font color="red">*</font><span id="dtDescTip" style="position:absolute;height:22px;width:250px"></span></td>
							</tr>
							<tr class="MeNewTDLine" align="center">
