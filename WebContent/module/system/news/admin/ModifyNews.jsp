									...
									<tr >
										...
										<td width="75%" class="tatd" align="left">
											<textarea name="paramMap.newsContent" id="newsContent" style="display:none">${initMap.newsnews.newsContent}</textarea>
									   		<script type="text/javascript">
									   		CKEDITOR.replace('newsContent',{ width : 700,filebrowserUploadUrl : 'ckeditor/uploader?Type=File&TypeRoom=modifynews&newsno='+'${initMap.newsnews.newsNum}', filebrowserImageUploadUrl : 'ckeditor/uploader?Type=Image&TypeRoom=modifynews&newsno='+'${initMap.newsnews.newsNum}', filebrowserFlashUploadUrl : 'ckeditor/uploader?Type=Flash&TypeRoom=modifynews&newsno='+'${initMap.newsnews.newsNum}'});
											</script>
										</td>
									</tr>
									<tr  align="center">
