				...
				<td class="leftmiddl">
					...
					<div class="lt-command">
					 	...
					 	<s:if test="pmsIndex.sys_resource_News_class_List">
					 		<a href="decorateForwardAction.action?code=${pmsIndex.sys_resource_News_class_List.code}" style="background: none;color: #924100;">
					 	...
					 	<div style="float: right;margin-right: 15px;">
							...
							<s:if test="pmsIndex.sys_resource_news_create">
	 						<a href="decorateForwardAction.action?code=${pmsIndex.sys_resource_news_create.code}" class="fade-button" data-old-bg="rgb(124, 109, 91)" >
