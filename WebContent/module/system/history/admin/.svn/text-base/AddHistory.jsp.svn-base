						...
						<td width="100%" id="vback" valign="top"  style=" position:relative; background:url(images-ce/crud.png) center bottom no-repeat; background-size:100% 100%;">
							<div>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_9">
									...
									<tr >
										<td width="25%" class="tatd" align="right">资料介绍：</td>
										<td width="75%" class="tatd" align="left">
									...
									<tr >
										...
										<td width="75%" class="tatd" align="left">
											<textarea name="paramMap.historyContent" id="historyContent" style="display:none"></textarea>
									   		<script type="text/javascript">
									   		CKEDITOR.replace('historyContent',{ width : 700,filebrowserUploadUrl : 'ckeditor/uploader?Type=File&TypeRoom=addhistory', filebrowserImageUploadUrl : 'ckeditor/uploader?Type=Image&TypeRoom=addhistory', filebrowserFlashUploadUrl : 'ckeditor/uploader?Type=Flash&TypeRoom=addhistory' });
											</script>
										</td>
									</tr>
									<tr  align="center">
