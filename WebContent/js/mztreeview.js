...
MzTreeView.prototype.nodeToHTML = function(node, AtEnd)
{
  ...
  if(node.ctrl) HTML += "<input type='"+ node.ctrlType +"' name='"+ node.ctrlName +"' value="+ sid +
  	" id='"+ this.name +"_checbox_"+ id +"' style='height:15px;'"+
  	" onclick=\""+ this.name +".checkChild('"+ id +"')\" checked='"+ node.ctrlChecked +"'>"				//Rexliu add on 2007-1-23 14:29
  HTML += "<A "+
