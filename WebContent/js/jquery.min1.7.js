			...
			btnleft.click(function() {
				...
				if (!moving) {
					...
					if (sn > unitlen * unitdisplayed - maxlength) {
						jQuery.fn.xslider.scroll(scrollobj, -sn, settings.dir,
						function() {
							moving = false;
						});
					} else {
						jQuery.fn.xslider.scroll(scrollobj, 0, settings.dir,
						function() {
							moving = false;
						});
						sn = 0;
			...
			btnright.click(function() {
				...
				if (!moving) {
					...
					if (sn < offset - (unitlen * unitdisplayed - maxlength)) {
						...
						jQuery.fn.xslider.scroll(scrollobj, -offset, settings.dir,
						function() {
							moving = false;
						}); //滚动到最后一个位置;
						sn = offset;
