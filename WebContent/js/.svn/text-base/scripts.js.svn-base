...
$(document).ready(function () {
	...
	var frmAutoResizer = function () {
		...
		if ($("#layout_left").height() != $(window).innerHeight() - 70) {
            $("#layout_left").height($(window).innerHeight() - 70);
        }
        
		if ($("#layout_left_pms").height() != $(window).innerHeight() - 70) {
            $("#layout_left_pms").height($(window).innerHeight() - 70);
        }
       
        if ($("#layout_right").width() != windowFrmW - leftFrm ) {
            $("#layout_right").width(windowFrmW - leftFrm);
        }
        if ($("#layout_right").height() != $(window).innerHeight() - 110) {
            $("#layout_right").height($(window).innerHeight()-110);
        }
        ...
        if ($(".layout_left_menutab_body").height() != $(window).innerHeight() - topFrm - 87) {
            $(".layout_left_menutab_body").height($(window).innerHeight() - topFrm - 87);
        }
        ...
        if ($(".left_menutab_body").height() != $(window).innerHeight() - 125) {
            $(".left_menutab_body").height($(window).innerHeight() - 125);
        }
    ...
    //所有按钮渐变
	var needAnim = [".fade-button", ".login-info-more a",  ".res-list-pager a.pre", ".res-list-pager a.next", ".res-list-pager span.pager-info input[type=button]"];
    ...
    $(".login-info").hover(function () {
    	if($(this).parent().find(".login-info-more").is(":hidden")){
            ...
            $(this)[0].style.background="url(images-ce/infoOn.jpg) no-repeat";
        ...
        $(this)[0].style.background="url(images-ce/info.jpg) no-repeat";
   ...
   /* $(".gallery").hover(function () {
    ...
    $(".relative-res span.toggle").click(function () {
        if ($(".relative-res-body").height() > 0) {
            ...
            $(this).addClass("on");
            $(".relative-res-body").animate({ height: 100 }, 500);
        ...
        if (leftWidth == 0) {
           ...
           /*if($(window).innerWidth() <= 1024){
        	   var functionve=document.getElementById('mainFrameWelcome');
	   			if(functionve!=null){
	   				if(functionve.contentWindow.document.getElementById('bigimg')!=null){
	   					$(functionve.contentWindow.document.getElementById('bigimg')).show();
	   					$(functionve.contentWindow.document.getElementById('middleimg')).hide();		
	   				}
	   			}
           }*/
           ...
           // $(this).html("&gt;");id="" 
            /*if($(window).innerWidth() <= 1024){
				...
				if(functionve!=null){
					if(functionve.contentWindow.document.getElementById('bigimg')!=null){
						$(functionve.contentWindow.document.getElementById('bigimg')).hide();
						$(functionve.contentWindow.document.getElementById('middleimg')).show();
