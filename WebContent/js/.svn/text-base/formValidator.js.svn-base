...
$.formValidator = 
{
	...
	ajaxValid : function(returnObj)
	{
	    ...
	    if (typeof setting.changefunc == 'function'){
	    	setting = setting.changefunc(setting);
	    }
		if(setting.addidvalue)
		{
			var parm = "clientid="+id+"&paramMap."+id+"="+encodeURIComponent(srcjo.val());
...
$.fn.formValidator = function(cs) 
{
	...
	if(initConfig.tidymode){setting.tipcss = {"left" : "2px","width":"22px","height":"25px","display":"none"}};
...
$.fn.ajaxValidator = function(controlOptions)
{
	...
	//alert("ddd:" + controlOptions.data)
	controlOptions = controlOptions || {};
	$.extend(true, settings, controlOptions);
	//alert("c:" + controlOptions.data)
	return this.each(function()
	{
		$.formValidator.appendValid(this.id,settings);
	});
...
$.fn.showTooltips = function()
{
	if($("body [id=fvtt]").length==0){
		fvtt = $("<div id='fvtt' style='position:absolute;z-index:56002;width:250;height:22;'></div>");
		$("body").append(fvtt);
