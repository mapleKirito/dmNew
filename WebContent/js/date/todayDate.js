		...
		var CalendarHandler = {
			...
			//	$(".currentDay").show();
				...
				for (var i = 1; i < 13; i++) {
					...
					$("#selectMonthDiv div").css("color","#3D2406").css("font-weight","bold");
				...
				/*$("#selectMonthDiv>div").css("width", ($("#center").width() - 4) / 4 + "px").css("line-height", ($("#center").height() - 4) / 5 + "px");*/
				$("#selectMonthDiv>div").css("width", ($("#center").width() - 4) / 4 + "px").css("line-height", ($("#center").height() - 90) / 5 + "px");
				$("#centerMain").animate({
