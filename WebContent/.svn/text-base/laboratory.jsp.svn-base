...
$(document).ready(function(){
	$("#daohangOther").append($("<span>教学研究室flash</span>"));
});	
</script>
</head>
...
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"  id="denglu" align="middle">
	<param name="movie" value="flash/shiyanshi.swf" />
	...
	<!--[if !IE]>-->
	<object type="application/x-shockwave-flash" data="flash/shiyanshi.swf" width="100%" height="500">
		<param name="movie" value="flash/shiyanshi.swf" />
		<param name="quality" value="high" />
		<param name="bgcolor" value="#eeeef0" />
		<param name="play" value="true" />
