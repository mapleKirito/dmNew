...
$(document).ready(function(){
	$("#daohangOther").append($("<span>文物博览室flash</span>"));
});	
</script>
</head>
...
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"  id="denglu" align="middle">
	<param name="movie" value="flash/chenLieShi.swf" />
	...
	<!-- <[if !IE]> -->
	<object type="application/x-shockwave-flash" data="flash/chenLieShi.swf" width="100%" height="510">
		<param name="movie" value="flash/chenLieShi.swf" />
		<param name="quality" value="high" />
		<param name="bgcolor" value="#eeeef0" />
		<param name="play" value="true" />
