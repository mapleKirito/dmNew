...
$(document).ready(function(){
	$("#daohangOther").append($("<span>教师工作室flash</span>"));
});	
</script>
</head>
...
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"  id="denglu" align="middle">
	<param name="movie" value="flash/teacher.swf" />
	...
	<!--[if !IE]>-->
	<object type="application/x-shockwave-flash" data="flash/teacher.swf" width="100%" height="500">
		<param name="movie" value="flash/teacher.swf" />
		<param name="quality" value="high" />
		<param name="bgcolor" value="#e8e8e8" />
		<param name="play" value="true" />
