...
(function() {
	...
	window.CKEDITOR || (window.CKEDITOR = function() {
		...
		e = {
			...
			basePath: function() {
				...
				if (!f) for (var d = document.getElementsByTagName("script"), c = 0; c < d.length; c++) {
	...
	CKEDITOR.event.prototype = function() {
		...
		b.prototype = {
			getListenerIndex: function(a) {
				for (var f = 0,
				d = this.listeners; f < d.length; f++) if (d[f].fn == a) return f;
				return - 1
			}
		};
		return {
			...
			on: function(c, f, d, b, e) {
				...
				function j() {
					u.removeListener(c, f)
				}
				var p = a.call(this, c);
				if (p.getListenerIndex(f) < 0) {
					p = p.listeners;
					d || (d = this);
					isNaN(e) && (e = 10);
					var u = this;
					m.fn = f;
					m.priority = e;
					for (var t = p.length - 1; t >= 0; t--) if (p[t].priority <= e) {
						p.splice(t + 1, 0, m);
						return {
							removeListener: j
						}
			...
			fire: function() {
				...
				return function(h, m, j) {
					...
					if (p) {
						var t = p.listeners;
						if (t.length) for (var t = t.slice(0), y, n = 0; n < t.length; n++) {
							if (p.errorProof) try {
								y = t[n].call(this, j, m, f, b)
							} catch(w) {} else y = t[n].call(this, j, m, f, b);
							y === false ? d = 1 : typeof y != "undefined" && (m = y);
							if (a || d) break
						}
					}
					m = d ? false: typeof m == "undefined" ? true: m;
					a = h;
					d = u;
					return m
				}
		...
		CKEDITOR.tools = {
			...
			extend: function(a) {
				...
				for (var c = 1; c < f; c++) {
					var e = arguments[c],
					o;
					for (o in e) if (d === true || a[o] == null) if (!b || o in b) a[o] = e[o]
				}
				return a
			},
			...
			htmlDecode: function(a) {
				return a.replace(g, "&").replace(h, ">").replace(m, "<")
			},
			htmlEncodeAttr: function(a) {
				return a.replace(d, "&quot;").replace(f, "&lt;").replace(c, "&gt;")
			},
			htmlDecodeAttr: function(a) {
				return a.replace(j, '"').replace(m, "<").replace(h, ">")
			},
			...
			indexOf: function(a, f) {
				if (typeof f == "function") for (var d = 0,
				b = a.length; d < b; d++) {
					if (f(a[d])) return d
				} else {
			...
			normalizeCssText: function(a, f) {
				var d = [],
				b,
				c = CKEDITOR.tools.parseCssText(a, true, f);
			...
			enableHtml5Elements: function(a, f) {
				for (var d = ["abbr", "article", "aside", "audio", "bdi", "canvas", "data", "datalist", "details", "figcaption", "figure", "footer", "header", "hgroup", "mark", "meter", "nav", "output", "progress", "section", "summary", "time", "video"], b = d.length, c; b--;) {
			...
			checkIfAnyArrayItemMatches: function(a, f) {
				for (var d = 0,
				b = a.length; d < b; ++d) if (a[d].match(f)) return true;
				return false
			},
	...
	CKEDITOR.dom.domObject.prototype = function() {
		...
		a.setCustomData = function(a, c) {
			var f = this.getUniqueId(); (e[f] || (e[f] = {}))[a] = c;
			return this
		};
		...
		clone: function(a, e) {
			...
			c = function(f) {
				...
				if (f.nodeType == CKEDITOR.NODE_ELEMENT) {
					...
					if (a) for (var f = f.childNodes,
					d = 0; d < f.length; d++) c(f[d])
				}
			};
			c(b);
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
		...
		getByAddress: function(a, e) {
			...
			c = 0; b && c < a.length; c++) {
				var f = a[c];
				if (e) for (var d = -1,
				g = 0; g < b.childNodes.length; g++) {
					var h = b.childNodes[g];
					if (! (e === true && h.nodeType == 3 && h.previousSibling && h.previousSibling.nodeType == 3)) {
						d++;
						if (d == f) {
							b = h;
							break
	...
	CKEDITOR.dom.element.clearMarkers = function(a, e, b) {
		...
		function b(a) {
			for (var d = 0,
			b = 0,
			e = c[a].length; b < e; b++) d = d + (parseInt(this.getComputedStyle(c[a][b]) || 0, 10) || 0);
			return d
		}
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			getLast: function(a) {
				var d = this.$.lastChild; (d = d && new CKEDITOR.dom.node(d)) && (a && !a(d)) && (d = d.getPrevious(a));
				return d
			},
			getStyle: function(a) {
			...
			moveChildren: function(a, d) {
				...
				if (b != a) {
					var c;
					if (d) for (; c = b.lastChild;) a.insertBefore(b.removeChild(c), a.firstChild);
					else for (; c = b.firstChild;) a.appendChild(b.removeChild(c))
				}
			},
			...
			removeAttributes: function(a) {
				if (CKEDITOR.tools.isArray(a)) for (var d = 0; d < a.length; d++) this.removeAttribute(a[d]);
				else for (d in a) a.hasOwnProperty(d) && this.removeAttribute(d)
			},
			removeStyle: function(a) {
				...
				if (!d.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
					...
					for (var d = [], e = 0; e < b.length; e++) if (c) for (var j = 0; j < c.length; j++) d.push([a, b[e], c[j]].join("-"));
			...
			getDocumentPosition: function(a) {
				...
				c = this.getDocument(),
				e = c.getBody(),
				j = c.$.compatMode == "BackCompat";
				if (document.documentElement.getBoundingClientRect) {
					var p = this.$.getBoundingClientRect(),
					u = c.$.documentElement,
					t = u.clientTop || e.$.clientTop || 0,
					y = u.clientLeft || e.$.clientLeft || 0,
					n = true;
					if (CKEDITOR.env.ie) {
						n = c.getDocumentElement().contains(this);
						c = c.getBody().contains(this);
						n = j && c || !j && n
					}
					if (n) {
						d = p.left + (!j && u.scrollLeft || e.$.scrollLeft);
						d = d - y;
			...
			scrollIntoParent: function(a, b, c) {
				...
				function t(a, b) {
					...
					c = a.getWindow();
					if (!c.equals(b)) {
						c = t(CKEDITOR.dom.element.get(c.$.frameElement), b);
						d.x = d.x + c.x;
						d.y = d.y + c.y
					}
					return d
			...
			copyAttributes: function(a, b) {
				...
				e = 0; e < c.length; e++) {
					...
					else if (!CKEDITOR.env.ie || this.hasAttribute(j)) {
						p = this.getAttribute(j);
			...
			forEach: function(a, b, c) {
				...
				if (e !== false) for (var c = this.getChildren(), m = 0; m < c.count(); m++) {
					e = c.getItem(m);
	...
	!0, {
		...
		function a(a, b) {
			...
			i, k = this.guard,
			l = this.type,
			q = a ? "getPreviousSourceNode": "getNextSourceNode";
			if (!a && !this._.guardLTR) {
				var x = d.type == CKEDITOR.NODE_ELEMENT ? d: d.getParent(),
				s = d.type == CKEDITOR.NODE_ELEMENT ? d.getChild(p) : d.getNext();
				this._.guardLTR = function(a, b) {
					return (!b || !x.equals(a)) && (!s || !a.equals(s)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
				}
			}
			if (a && !this._.guardRTL) {
				var g = f.type == CKEDITOR.NODE_ELEMENT ? f: f.getParent(),
				j = f.type == CKEDITOR.NODE_ELEMENT ? e ? f.getChild(e - 1) : null: f.getPrevious();
				this._.guardRTL = function(a, b) {
					return (!b || !g.equals(a)) && (!j || !a.equals(j)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
				}
			}
			var m = a ? this._.guardRTL: this._.guardLTR;
			i = k ?
			function(a, b) {
				return m(a, b) === false ? false: k(a, b)
			}: m;
			if (this.current) d = this.current[q](false, l, i);
			else {
				if (a) d.type == CKEDITOR.NODE_ELEMENT && (d = p > 0 ? d.getChild(p - 1) : i(d, true) === false ? null: d.getPreviousSourceNode(true, l, i));
				else {
					d = f;
					if (d.type == CKEDITOR.NODE_ELEMENT && !(d = d.getChild(e))) d = i(f, true) === false ? null: f.getNextSourceNode(true, l, i)
				}
				d && i(d) === false && (d = null)
			}
			for (; d && !this._.end;) {
		...
		function b(a) {
			...
			if (a.type == CKEDITOR.NODE_ELEMENT) {
				...
				var b;
				if (b = !CKEDITOR.env.needsBrFiller) if (b = a.is(p)) a: {
					b = 0;
	...
	CKEDITOR.dom.range = function(a) {
		...
		function e(a) {
			...
			return function(d) {
				return c(d) || b(d) ? true: !a && g(d) || d.type == CKEDITOR.NODE_ELEMENT && d.is(CKEDITOR.dtd.$removeEmpty)
			}
		}
		function b(a) {
			return function() {
		...
		f = function(a, b, c, d) {
			...
			else if (e.getChildCount() > 0) if (r >= e.getChildCount()) {
			...
			} else if (o) if (o >= f.getChildCount()) {
				f = f.append(a.document.createText(""));
				i = true
			} else f = f.getChild(o).getPrevious();
			else {
			...
			if (b == 2) {
				...
				if (q && x && (f.$.parentNode != q.$.parentNode || e.$.parentNode != x.$.parentNode)) {
					...
					if (d && q.type == CKEDITOR.NODE_ELEMENT) {
		...
		CKEDITOR.dom.range.prototype = {
			...
			enlarge: function(a, b) {
				...
				case CKEDITOR.ENLARGE_ELEMENT:
					...
					if (s.type == CKEDITOR.NODE_TEXT) {
						if (j) {
							s = !CKEDITOR.tools.trim(s.substring(0, j)).length && s;
							x = !!s
						}
						if (s && !(l = s.getPrevious())) k = s.getParent()
					} else {
						j && (l = s.getChild(j - 1) || s.getLast());
						l || (k = s)
					}
					for (k = c(k); k || l;) {
						if (k && !l) { ! q && k.equals(e) && (q = true);
							if (f ? k.isBlockBoundary() : !o.contains(k)) break;
							if (!x || k.getComputedStyle("display") != "inline") {
								x = false;
								q ? r = k: this.setStartBefore(k)
							}
							l = k.getPrevious()
						}
						for (; l;) {
							...
							if (l.type == CKEDITOR.NODE_COMMENT) l = l.getPrevious();
								...
								if (l.type == CKEDITOR.NODE_TEXT) {
									...
									d.test(g) && (l = null);
									s = /[\s\ufeff]$/.test(g)
								} else if ((l.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && l.is("br")) && !l.data("cke-bookmark")) if (x && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
									g = l.getText();
									if (d.test(g)) l = null;
									else for (var j = l.$.getElementsByTagName("*"), m = 0, F; F = j[m++];) if (!CKEDITOR.dtd.$removeEmpty[F.nodeName.toLowerCase()]) {
										l = null;
										break
									}
									l && (s = !!g.length)
					...
					q = x = false;
					var h = function(a, b) {
						var c = new CKEDITOR.dom.range(o);
						c.setStart(a, b);
					...
					if (s.type == CKEDITOR.NODE_TEXT) if (CKEDITOR.tools.trim(s.substring(j)).length) x = true;
						...
						x = !s.getLength();
						if (j == s.getLength()) {
							if (! (l = s.getNext())) k = s.getParent()
						} else h(s, j) && (k = s.getParent())
					} else(l = s.getChild(j)) || (k = s);
					for (; k || l;) {
						if (k && !l) { ! q && k.equals(e) && (q = true);
							if (f ? k.isBlockBoundary() : !o.contains(k)) break;
							if (!x || k.getComputedStyle("display") != "inline") {
								x = false;
								q ? i = k: k && this.setEndAfter(k)
							}
							l = k.getNext()
						}
						for (; l;) {
							...
							if (l.type == CKEDITOR.NODE_TEXT) {
								...
								if ((l.$.offsetWidth > 0 || b && l.is("br")) && !l.data("cke-bookmark")) if (x && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
									...
									if (d.test(g)) l = null;
										...
										j = l.$.getElementsByTagName("*");
										for (m = 0; F = j[m++];) if (!CKEDITOR.dtd.$removeEmpty[F.nodeName.toLowerCase()]) {
											l = null;
											break
										}
									}
				...
				case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
					...
					var J, A, E = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
						br: 1
					}: null),
					v = null,
					z = function(a) {
			...
			shrink: function(a, b, c) {
				if (!this.collapsed) {
					...
					d.guard = function(b, d) {
						if (l(b)) return true;
						if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(q) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return false; ! d && b.type == CKEDITOR.NODE_ELEMENT && (q = b);
						return true
					};
			...
			moveToElementEditablePosition: function(a, b) {
				...
				for (var c = 0; a;) {
					...
					f = c,
					e = void 0;
					d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(false) && (e = d[b ? "getLast": "getFirst"](j)); ! f && !e && (e = d[b ? "getPrevious": "getNext"](j));
					a = e
				}
				return !! c
			},
		...
		a.prototype = {
			getNextParagraph: function(a) {
				...
				if (!this._.started) {
					...
					h = o.startPath();
					var r = o.endPath(),
					i = !o.collapsed && f(o, h.block),
					k = !o.collapsed && f(o, r.block, 1);
				...
				for (this._.nextNode = null; r;) {
					var i = 0,
					k = r.hasAscendant("pre"),
					l = r.type != CKEDITOR.NODE_ELEMENT,
					q = 0;
					if (l) r.type == CKEDITOR.NODE_TEXT && d.test(r.getText()) && (l = 0);
					else {
						var x = r.getName();
						if (CKEDITOR.dtd.$block[x] && r.getAttribute("contenteditable") == "false") {
							b = r;
							c(this, a, b);
							break
						} else if (r.isBlockBoundary(this.forceBrBreak && !k && {
							br: 1
						})) {
							if (x == "br") l = 1;
							else if (!h && !r.getChildCount() && x != "hr") {
								b = r;
								y = r.equals(o);
								break
							}
					...
					y = (!i || l) && r.equals(o);
					if (h && !i) for (; ! r.getNext(m) && !y;) {
						x = r.getParent();
						if (x.isBlockBoundary(this.forceBrBreak && !k && {
							br: 1
						})) {
							i = 1;
							l = 0;
					...
					l && h.setEndAt(r, CKEDITOR.POSITION_AFTER_END);
					r = e(r, q, o);
					if ((y = !r) || i && h) break
				}
				if (!b) {
					...
					else if (!b || this.enforceRealBlocks && b.is(j)) {
				...
				if (n)(n = b.getPrevious()) && n.type == CKEDITOR.NODE_ELEMENT && (n.getName() == "br" ? n.remove() : n.getLast() && n.getLast().$.nodeName.toLowerCase() == "br" && n.getLast().remove());
				if (w)(n = b.getLast()) && n.type == CKEDITOR.NODE_ELEMENT && n.getName() == "br" && (!CKEDITOR.env.needsBrFiller || n.getPrevious(g) || n.getNext(g)) && n.remove();
	...
	CKEDITOR.config = {
		...
		function a(a, b, c, d, f) {
			...
			for (e in b) {
				i = b[e];
				i = typeof i == "boolean" ? {}: typeof i == "function" ? {
					match: i
				}: Q(i);
		...
		function y(a, b, d, f) {
			...
			if (f.doTransform) if (k = a._.transformations[b.name]) {
				t(b);
				for (l = 0; l < k.length; ++l) q(a, b, k[l]);
				w(b)
			}
			if (f.doFilter) {
				a: {
					...
					if (!a && !k) a = null;
						...
						if (l) {
							n = 0;
							for (r = l.length; n < r; ++n) if (c(l[n], b, g) === false) {
								a = null;
								break a
							}
						}
						if (B) {
							n = 0;
							for (r = B.length; n < r; ++n) c(B[n], b, g)
						}
						if (a) {
							n = 0;
							for (r = a.length; n < r; ++n) e(a[n], b, g, s)
						}
						if (k) {
							n = 0;
							for (r = k.length; n < r; ++n) e(k[n], b, g, s)
						}
						a = g
					}
				}
				...
				if (!a.allAttributes) for (v in l) if (!r[v]) if (j.test(v)) {
					if (v != (h = v.replace(/^data-cke-saved-/, "")) && !r[h]) {
						delete l[v];
						n = true
					}
				} else {
				...
				if (!a.allStyles || a.hadInvalidStyle) {
					for (v in A) a.allStyles || x[v] ? D.push(v + ":" + A[v]) : n = true;
					if (D.length) l.style = D.sort().join("; ")
				} else if (z) l.style = z;
				if (!a.allClasses || a.hadInvalidClass) {
					for (v = 0; v < B.length; ++v)(a.allClasses || k[B[v]]) && g.push(B[v]);
					g.length && (l["class"] = g.sort().join(" "));
					s && g.length < s.split(/\s+/).length && (n = true)
				} else s && (l["class"] = s);
				n && (i = F);
				if (!f.skipFinalValidation && !o(b)) {
					d.push(b);
					return F
				}
			}
			if (f.toHtml) b.name = b.name.replace(aa, "cke:$1");
			return i
		}
		function n(a) {
			var b = [],
		...
		function k(a) {
			return a.type == CKEDITOR.NODE_ELEMENT && (a.name == "br" || N.$block[a.name])
		}
		function l(a, b, c) {
			var d = a.name;
			if (N.$empty[d] || !a.children.length) if (d == "hr" && b == "br") a.replaceWith(i());
				...
				a.remove()
			} else if (N.$block[d] || d == "tr") if (b == "br") {
				...
				b: {
					...
					o; e < q; ++e) {
						o = d[e];
						if (o.type == CKEDITOR.NODE_ELEMENT && !f[o.name]) {
							f = false;
							break b
						}
					}
				...
				if (f) {
					...
					f = a.parent;
					for (var e = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.name == "body",
					l, q = d.length; q > 0;) {
						o = d[--q];
						if (e && (o.type == CKEDITOR.NODE_TEXT || o.type == CKEDITOR.NODE_ELEMENT && N.$inline[o.name])) {
							if (!l) {
							...
							l = null;
							o.insertAfter(a);
							f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (o.type == CKEDITOR.NODE_ELEMENT && !N[f.name][o.name]) && c.push({
								check: "el-up",
								el: o
							})
						}
		...
		function x(a, b) {
			...
			for (e in d) if (e == "class") {
				c = d[e].split(/\s+/);
				for (q = a.classes.join("|"); o = c.pop();) if (q.indexOf(o) == -1) return false
		...
		CKEDITOR.filter.prototype = {
			allow: function(b, c, f) {
				...
				if (typeof b == "string") b = p(b);
					...
					for (e = 0; e < b.length; ++e) i = this.allow(b[e], c, f);
					return i
				}
			...
			applyTo: function(a, b, c, d) {
				...
				a.forEach(function(a) {
					if (a.type == CKEDITOR.NODE_ELEMENT) {
						...
						a: {
							...
							c = [];
							var o, l, n;
							if (i) for (l = 0; l < i.length; ++l) if ((n = d.match(i[l])) && n[0].length == d.length) {
								c = true;
								break a
							}
				...
				null, true);
				e.length && (k = true);
				for (var n, a = [], d = E[d || (this.editor ? this.editor.enterMode: CKEDITOR.ENTER_P)]; c = e.pop();) c.type == CKEDITOR.NODE_ELEMENT ? l(c, d, a) : c.remove();
				for (; n = a.pop();) {
					c = n.el;
					if (c.parent) switch (n.check) {
					case "it":
						N.$removeEmpty[c.name] && !c.children.length ? l(c, d, a) : o(c) || l(c, d, a);
						break;
					case "el-up":
						c.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && !N[c.parent.name][c.name] && l(c, d, a);
						break;
					case "parent-down":
						c.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && !N[c.parent.name][c.name] && l(c.parent, d, a)
					}
				}
				return k
			},
			...
			addContentForms: function(a) {
				if (!this.disabled && a) {
					...
					if (f) {
						for (b = 0; b < a.length; ++b) d.push(s(a[b], f));
				...
				if (!this.disabled && a) {
					...
					for (f = 0; f < a.length; ++f) {
						...
						for (i = 0; i < b.length; ++i) {
							...
							if (!e) {
								e = q;
								e = e.element ? e.element: o ? o.match(/^([a-z0-9]+)/i)[0] : e.left.getDefinition().element
							}
							l instanceof CKEDITOR.style && (l = M(l));
							c.push({
								check: o == e ? null: o,
								left: l,
								right: typeof k == "string" ? R(k) : k
							})
						}
						b = e;
						d[b] || (d[b] = []);
			...
			check: function(a, b, c) {
				...
				if (typeof a == "string") {
					...
					if (f) {
						f = Q(f);
						i.style = CKEDITOR.tools.writeCssText(f, true)
					} else f = {};
					f = {
						name: d.element,
						attributes: i,
				...
				if (b !== false && (l = this._.transformations[f.name])) {
					for (d = 0; d < l.length; ++d) q(this, f, l[d]);
					w(f)
				}
				y(this, i, o, {
					doFilter: true,
				...
				b = o.length > 0 ? false: CKEDITOR.tools.objectCompare(f.attributes, i.attributes, true) ? true: false;
		...
		ba = CKEDITOR.filter.transformationsTools = {
			...
			lengthToAttribute: function(a, b, c) {
				...
				if (! (c in a.attributes)) {
					var d = a.styles[b],
					f = d && d.match(/^(\d+)(?:\.\d*)?px$/);
					f ? a.attributes[c] = f[1] : d == A && (a.attributes[c] = A)
				}
				delete a.styles[b]
			},
			...
			transform: function(a, b) {
				if (typeof b == "string") a.name = b;
					...
					o;
					a.name = c.element;
					for (e in f) if (e == "class") {
						c = a.classes.join("|");
						for (q = f[e].split(/\s+/); o = q.pop();) c.indexOf(o) == -1 && a.classes.push(o)
		...
		CKEDITOR.focusManager.prototype = {
			focus: function(a) {
				...
				if (!this.hasFocus && !this._.locked) { (a = CKEDITOR.currentInstance) && a.focusManager.blur(1);
					this.hasFocus = true; (a = this._.editor.container) && a.addClass("cke_focus");
	...
	CKEDITOR.scriptLoader = function() {
		...
		return {
			load: function(b, c, f, d) {
				...
				j = [],
				p = function(a) {
					c && (g ? c.call(f, a) : c.call(f, m, j))
				};
				if (h === 0) p(true);
				else {
					var u = function(a, b) { (b ? m: j).push(a);
						if (--h <= 0) {
	...
	CKEDITOR.resourceManager.prototype = {
		...
		load: function(a, e, b) {
			...
			function(a, d) {
				...
				for (var f = 0; f < a.length; f++) for (var n = g[a[f]], j = 0; j < n.length; j++) {
					var o = n[j];
					h[o] = this.get(o);
					c[o] = 1
				}
			...
			g = function(b) {
				...
				function(a) {
					...
					for (h in a) {
						...
						t = u && u.requires;
						if (!e[h]) {
							if (u.icons) for (var y = u.icons.split(","), n = y.length; n--;) CKEDITOR.skin.addIcon(y[n], u.path + "icons/" + (CKEDITOR.env.hidpi && u.hidpi ? "hidpi/": "") + y[n] + ".png");
							e[h] = 1
						}
						if (t) {
							t.split && (t = t.split(","));
							for (u = 0; u < t.length; u++) d[t[u]] || b.push(t[u])
						}
					}
	...
	CKEDITOR.event.implementOn(CKEDITOR.ui); (function() {
		function a(a, c, d) {
			...
			if (c !== void 0) {
				...
				if (! (d == CKEDITOR.ELEMENT_MODE_INLINE ? c.is(CKEDITOR.dtd.$editable) || c.is("textarea") : d == CKEDITOR.ELEMENT_MODE_REPLACE ? !c.is(CKEDITOR.dtd.$nonBodyContent) : 1)) throw Error('The specified element mode is not supported on element: "' + c.getName() + '".');
				this.element = c;
				this.elementMode = d;
		...
		function d(a) {
			...
			c = y[b] || (y[b] = {});
			if (c.fn) {
				c.fn.call(a, a.config); (CKEDITOR.getUrl(a.config.customConfig) == b || !d(a)) && a.fireOnce("customConfigLoaded")
		...
		function p(a) {
			...
			function(c) {
				...
				for (var i in c) {
					...
					if (r && (A = r.match(l))) for (; r = A.pop();) CKEDITOR.tools.setTimeout(function(a, b) {
						throw Error('Plugin "' + a.replace(",", "") + '" cannot be removed from the plugins list, because it\'s required by "' + b + '" plugin.');
					},
					0, null, [r, i]);
					if (k && !a.lang[i]) {
						k.split && (k = k.split(","));
						if (CKEDITOR.tools.indexOf(k, a.langCode) >= 0) g = a.langCode;
						else {
							g = a.langCode.replace(/-.*/, "");
							g = g != a.langCode && CKEDITOR.tools.indexOf(k, g) >= 0 ? g: CKEDITOR.tools.indexOf(k, "en") >= 0 ? "en": k[0]
						}
						if (!o.langEntries || !o.langEntries[g]) e.push(CKEDITOR.getUrl(o.path + "lang/" + g + ".js"));
						else {
							a.lang[i] = o.langEntries[g];
							g = null
						}
					}
					f.push(g);
				...
				function() {
					...
					for (i = 0; i < a.config.blockedKeystrokes.length; i++) a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[i]] = 1;
					a.status = "loaded";
					a.fireOnce("loaded");
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			...
			_attachToForm: function() {
				...
				if (c.is("textarea") && d) {
					d.on("submit", a);
					if (d.$.submit && d.$.submit.call && d.$.submit.apply) d.$.submit = CKEDITOR.tools.override(d.$.submit,
					function(b) {
						return function() {
							a();
			...
			destroy: function(a) {
				this.fire("beforeDestroy"); ! a && u.call(this);
				this.editable(null);
				this.filter.destroy();
				delete this.filter;
			...
			setKeystroke: function() {
				...
				b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [[].slice.call(arguments, 0)], c, d, f = b.length; f--;) {
					c = b[f];
					d = 0;
	...
	CKEDITOR.htmlParser = function() {
		...
		CKEDITOR.htmlParser.prototype = {
			...
			parse: function(b) {
				for (var c, f, d = 0,
				g; c = this._.htmlPartsRegex.exec(b);) {
					f = c.index;
					if (f > d) {
						d = b.substring(d, f);
						if (g) g.push(d);
					...
					if (g) g.push(c[0]);
						...
						if (!/="/.test(f)) {
							...
							if (c) for (; m = a.exec(c);) {
								...
								m = m[2] || m[3] || m[4] || "";
								h[p] = !m && e[p] ? p: CKEDITOR.tools.htmlDecodeAttr(m)
							}
							this.onTagOpen(f, h, j); ! g && CKEDITOR.dtd.$cdata[f] && (g = [])
						}
	...
	"use strict"; (function() {
		...
		CKEDITOR.htmlParser.node.prototype = {
			...
			getAscendant: function(a) {
				var e = typeof a == "function" ? a: typeof a == "string" ?
				function(b) {
					return b.name == a
				}: function(b) {
					return b.name in a
	...
	CKEDITOR.htmlParser.fragment = function() {
		...
		CKEDITOR.htmlParser.fragment.fromHtml = function(d, g, h) {
			function m(a) {
				var b;
				if (o.length > 0) for (var c = 0; c < o.length; c++) {
					...
					f = d.name,
					e = CKEDITOR.dtd[f],
					l = i.name && CKEDITOR.dtd[i.name];
					if ((!l || l[f]) && (!a || !e || e[a] || !CKEDITOR.dtd[a])) {
						if (!b) {
							j();
							b = 1
						}
			...
			function u(b, c, d) {
				...
				if (b.previous === void 0) {
					...
					p(b); (!a(b) || b.children.length) && c.add(b);
					b.name == "pre" && (l = false);
			...
			w = g instanceof CKEDITOR.htmlParser.element ? g: typeof g == "string" ? new CKEDITOR.htmlParser.element(g) : new CKEDITOR.htmlParser.fragment,
			o = [],
			r = [],
			i = w,
			k = w.name == "textarea",
			l = w.name == "pre";
			n.onTagOpen = function(d, f, g, h) {
				f = new CKEDITOR.htmlParser.element(d, f);
				if (f.isUnknown && g) f.isEmpty = true;
				f.isOptionalClose = h;
				if (a(f)) o.push(f);
				else {
					if (d == "pre") l = true;
			...
			n.onText = function(a) {
				if ((!i._.hasInlineStarted || r.length) && !l && !k) {
					a = CKEDITOR.tools.ltrim(a);
					if (a.length === 0) return
				}
				var b = i.name,
				d = b ? CKEDITOR.dtd[b] || (i._.isBlockLike ? CKEDITOR.dtd.div: CKEDITOR.dtd.span) : c;
				if (!k && !d["#"] && b in e) {
					n.onTagOpen(f[b] || "");
					n.onText(a)
				} else {
		...
		CKEDITOR.htmlParser.fragment.prototype = {
			...
			forEach: function(a, b, c) {
				...
				if (f !== false) for (var c = this.children,
				e = 0; e < c.length; e++) {
					f = c[e];
	...
	"use strict"; (function() {
		...
		CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
			...
			proto: {
				addRules: function(a, c) {
					...
					else if (c && "priority" in c) f = c.priority;
				...
				onElement: function(a, c) {
					for (var f = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], d, e = 0; e < 3; e++) if (d = f[e]) {
						d = d.exec(a, c, this);
		...
		a.prototype = {
			...
			addMany: function(a, c, f) {
				for (var d = [this.findIndex(c), 0], e = 0, h = a.length; e < h; e++) d.push({
					value: a[e],
					priority: c,
					options: f
				});
			...
			findIndex: function(a) {
				...
				f = c.length - 1; f >= 0 && a < c[f].priority;) f--;
				return f + 1
			},
			exec: function(a, c) {
				...
				for (u = 0; u < h; u++) {
					...
					p = e[u];
					if (! (a.nonEditable && !p.options.applyToAll || a.nestedEditable && p.options.excludeNestedEditable)) {
						p = p.value.apply(null, d);
			...
			execOnName: function(a, c) {
				...
				e = d.length,
				h; c && f < e; f++) {
					h = d[f]; ! (a.nonEditable && !h.options.applyToAll || a.nestedEditable && h.options.excludeNestedEditable) && (c = c.replace(h.value[0], h.value[1]))
				}
				return c
			}
		}
		...
		function a(a, e) {
			...
			function q(a, f) {
				return function(e) {
					if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if (i = (typeof f == "function" ? f(e) : f) !== false) if (!r && !CKEDITOR.env.needsBrFiller && e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) i = false;
			...
			function A(a, b) {
				if ((!r || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && a.name == "br" && !a.attributes["data-cke-eol"]) return true;
				var c;
				if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(o))) {
					if (c.index) { (new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a);
						a.value = c[0]
					}
					if (!CKEDITOR.env.needsBrFiller && r && (!b || a.parent.name in v)) return true;
					if (!r) if ((c = a.previous) && c.name == "br" || !c || d(c)) return true
				}
				return false
			}
			var s = {
				...
				return function(b) {
					if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if ("data-cke-bogus" in e || "data-cke-eol" in e) delete e["data-cke-bogus"];
							...
							var i = c(b); ! e && d(b.parent) ? g(b.parent, k(a)) : d(e) && (i && !d(i)) && k(a).insertBefore(e)
						}
					}
				}
			} (r);
		...
		function w(a, b) {
			for (var c = [], d = b.config.protectedSource, f = b._.dataStore || (b._.dataStore = {
				id: 1
			}), e = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi, /<meta[\s\S]*?\/?>/gi].concat(d), a = a.replace(/<\!--[\s\S]*?--\>/g,
			function(a) {
				return "<\!--{cke_tempcomment}" + (c.push(a) - 1) + "--\>"
			}), i = 0; i < d.length; i++) a = a.replace(d[i],
			function(a) {
				a = a.replace(e,
				function(a, b, d) {
					return c[d]
			...
			function(a) {
				return a.replace(/<\!--\{cke_protected\}([^>]*)--\>/g,
				function(a, b) {
		...
		CKEDITOR.htmlDataProcessor.prototype = {
			toHtml: function(a, b, c, d) {
				...
				if (b && typeof b == "object") {
					...
					i = b.filter;
					l = b.enterMode
				} else e = b; ! e && e !== null && (e = f.editable().getName());
		...
		r = "{cke_protected}",
		i = CKEDITOR.dtd,
		k = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"],
		l = CKEDITOR.tools.extend({},
		i.$blockLimit, i.$block),
		q = {
			elements: {
				input: h,
				textarea: h
		...
		M = {
			...
			elements: {
				...
				table: function(a) {
					a.children.slice(0).sort(function(a, b) {
						...
						if (a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type) {
							c = CKEDITOR.tools.indexOf(k, a.name);
							d = CKEDITOR.tools.indexOf(k, b.name)
						}
						if (! (c > -1 && d > -1 && c != d)) {
				...
				title: function(a) {
					var b = a.children[0]; ! b && g(a, b = new CKEDITOR.htmlParser.text);
		...
		J = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi,
		A = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
		E = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
		v = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi,
		z = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
	})();
	"use strict";
	...
	CKEDITOR.htmlParser.cssStyle = function(a) {
		...
		CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
			...
			filter: function(a, b) {
				var d = this,
				e, h, b = d.getFilterContext(b);
				if (b.off) return true;
				if (!d.parent) a.onRoot(b, d);
				for (;;) {
					e = d.name;
					if (! (h = a.onElementName(b, e))) {
						this.remove();
						return false
					}
					d.name = h;
				...
				for (m in e) {
					j = m;
					for (h = e[m];;) if (j = a.onAttributeName(b, m)) if (j != m) {
						delete e[m];
						m = j
					} else break;
					else {
					...
					j && ((h = a.onAttribute(b, d, j, h)) === false ? delete e[j] : e[j] = h)
				}
			...
			getFirst: function(b) {
				...
				for (var f = 0,
				d = this.children.length; f < d; ++f) if (b(this.children[f])) return this.children[f];
				return null
			},
			getHtml: function() {
			...
			getFilterContext: function(a) {
				...
				}); ! a.off && this.attributes["data-cke-processor"] == "off" && b.push("off", true); ! a.nonEditable && this.attributes.contenteditable == "false" ? b.push("nonEditable", true) : a.nonEditable && (!a.nestedEditable && this.attributes.contenteditable == "true") && b.push("nestedEditable", true);
	...
	CKEDITOR.replaceClass = "ckeditor"; (function() {
		function a(a, f, d, g) {
			...
			d && h.setData(d, null, true);
			h.on("loaded",
			function() {
				b(h);
				g == CKEDITOR.ELEMENT_MODE_REPLACE && (h.config.autoUpdateElement && a.$.form) && h._attachToForm();
		...
		CKEDITOR.editor.prototype.resize = function(a, b, d, e) {
			...
			j = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement,
	...
	CKEDITOR.config.startupMode = "wysiwyg"; (function() {
		function a(a) {
			...
			q = l.getRanges()[0],
			x;
			if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if (l = e(l, d)) {
				l.appendBogus();
				x = CKEDITOR.env.ie
			}
			if (g(b, d.block, f) && q.collapsed && !q.getCommonAncestor().isReadOnly()) {
				d = q.clone();
				...
				if (!f.checkForward() || d.checkStartOfBlock() && d.checkEndOfBlock()) {
					b = q.fixBlock(true, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div": "p");
		...
		CKEDITOR.editable = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				insertElementIntoRange: function(a, b) {
					...
					var g, s;
					if (f) for (; (g = b.getCommonAncestor(0, 1)) && (s = CKEDITOR.dtd[g.getName()]) && (!s || !s[e]);) if (g.getName() in CKEDITOR.dtd.span) b.splitElement(g);
				...
				setup: function() {
					...
					function() {
						var b = this.getData();
						this.is("textarea") || a.config.ignoreEmptyParagraph !== false && (b = b.replace(u,
						function(a, b) {
							return b
						}));
						a.setData(b, null, 1)
					...
					if (!this.is("textarea")) {
						...
						function(b) {
							...
							if (c in l) {
								...
								if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (f = b.getSelectedElement()) || (f = d(b))) {
									...
									a.fire("saveSnapshot");
									e = 1
								} else if (i.collapsed) if ((g = k.block) && (j = g[c ? "getPrevious": "getNext"](t)) && j.type == CKEDITOR.NODE_ELEMENT && j.is("table") && i[c ? "checkStartOfBlock": "checkEndOfBlock"]()) {
									a.fire("saveSnapshot");
									...
									a.fire("saveSnapshot");
									e = 1
								} else if (k.blockLimit && k.blockLimit.is("td") && (h = k.blockLimit.getAscendant("table")) && i.checkBoundaryOfElement(h, c ? CKEDITOR.START: CKEDITOR.END) && (j = h[c ? "getPrevious": "getNext"](t))) {
									a.fire("saveSnapshot");
									i["moveToElementEdit" + (c ? "End": "Start")](j);
									i.checkStartOfBlock() && i.checkEndOfBlock() ? j.remove() : i.select();
									a.fire("saveSnapshot");
									e = 1
								} else if ((h = k.contains(["td", "th", "caption"])) && i.checkBoundaryOfElement(h, c ? CKEDITOR.START: CKEDITOR.END)) e = 1
							}
							return ! e
						});
						...
						CKEDITOR.env.ie || this.attachListener(this, "mousedown",
						function(b) {
							...
							if (b in l) {
								...
								if (d.collapsed) {
									...
									a: {
										...
										if (f) if (d[c ? "checkStartOfBlock": "checkEndOfBlock"]()) if (!d.moveToClosestEditablePosition(f, !c) || !d.collapsed) e = false;
											...
											if ((d = d.startPath().block) && (!d || !d.contains(f))) {
												a.fire("saveSnapshot");
												var k; (k = (c ? d: f).getBogus()) && k.remove();
												e = a.getSelection();
												k = e.createBookmarks(); (c ? f: d).moveChildren(c ? d: f, false);
									...
									if (!e || !k || e.equals(k)) b = false;
										...
										a.fire("saveSnapshot"); (f = e.getBogus()) && f.remove();
										c.deleteContents();
										if (k.getParent()) {
											k.moveChildren(e, false);
											b.lastElement.mergeSiblings();
											j(e, k, true)
										}
		...
		var p = CKEDITOR.dom.walker.bogus(),
		u = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,
		t = CKEDITOR.dom.walker.whitespaces(true),
		...
		var n = function() {
			...
			function b(c, d) {
				var e, f, i, l, k = [],
				q = d.range.startContainer;
				e = d.range.startPath();
				for (var q = h[q.getName()], g = 0, s = c.getChildren(), j = s.count(), m = -1, p = -1, n = 0, M = e.contains(h.$list); g < j; ++g) {
					e = s.getItem(g);
					if (a(e)) {
						i = e.getName();
						if (M && i in CKEDITOR.dtd.$list) k = k.concat(b(e, d));
							...
							l = !!q[i];
							if (i == "br" && e.data("cke-eol") && (!g || g == j - 1)) {
								n = (f = g ? k[g - 1].node: s.getItem(g + 1)) && (!a(f) || !f.is("br"));
			...
			function d(b, c) {
				...
				q = 0,
				g = h[c],
				s = !b.is(h.$inline) || b.is("br");
				for (s && e.push(" "); q < l; q++) {
					k = f.getItem(q);
					a(k) && !k.is(g) ? e = e.concat(d(k, c)) : e.push(k)
				}
				s && e.push(" ");
				return e
			}
			...
			function f(b, c, d, e) {
				...
				if ((k = (new CKEDITOR.dom.walker(i)).next()) && a(k) && s[k.getName()] && (q = k.getPrevious()) && a(q) && !q.getParent().equals(b.startContainer) && d.contains(q) && e.contains(k) && k.isIdentical(q)) {
					k.moveChildren(q);
					k.remove();
					f(b, c, d, e)
				}
			...
			return function(s, n, u) {
				...
				if (!A.checkReadOnly()) {
					var v = (new CKEDITOR.dom.elementPath(A.startContainer, A.root)).blockLimit || A.root,
					n = {
						type: n,
						dontFilter: E,
						editable: s,
					...
					D,
					G;
					if (n.type == "text" && t.shrink(CKEDITOR.SHRINK_ELEMENT, true, false)) {
						z = CKEDITOR.dom.element.createFromHtml("<span>&nbsp;</span>", t.document);
						t.insertNode(z);
						t.setStartAfter(z)
					}
					B = new CKEDITOR.dom.elementPath(t.startContainer);
					n.endPath = D = new CKEDITOR.dom.elementPath(t.endContainer);
					if (!t.collapsed) {
						var v = D.block || D.blockLimit,
						y = t.getCommonAncestor();
						v && (!v.equals(y) && !v.contains(y) && t.checkEndOfBlock()) && n.zombies.push(v);
						t.deleteContents()
					}
					for (; (G = a(t.startContainer) && t.startContainer.getChild(t.startOffset - 1)) && a(G) && G.isBlockBoundary() && B.contains(G);) t.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END);
					...
					z = t.startPath();
					if (v = z.contains(e, false, 1)) {
						t.splitElement(v);
						n.inlineStylesRoot = v;
						n.inlineStylesPeak = z.lastElement
					}
					z = t.createBookmark(); (v = z.startNode.getPrevious(c)) && a(v) && e(v) && E.push(v); (v = z.startNode.getNext(c)) && a(v) && e(v) && E.push(v);
					for (v = z.startNode; (v = v.getParent()) && e(v);) E.push(v);
					t.moveToBookmark(z);
					if (z = u) {
						z = n.range;
						if (n.type == "text" && n.inlineStylesRoot) {
							...
							for (E = n.inlineStylesRoot.getParent(); ! G.equals(E);) {
						...
						if (/^\s+|\s+$/.test(u) && "span" in CKEDITOR.dtd[G]) var w = '<span data-cke-marker="1">&nbsp;</span>',
						u = w + u + w;
						...
						if ((w = z.startPath().block) && !(w.getChildCount() == 1 && w.getBogus())) a: {
							var H;
							if (G.getChildCount() == 1 && a(H = G.getFirst()) && H.is(j)) {
								w = H.getElementsByTag("*");
								z = 0;
								for (E = w.count(); z < E; z++) {
									t = w.getItem(z);
									if (!t.is(p)) break a
								}
								H.moveChildren(H.getParent(1));
								H.remove()
							}
						}
						n.dataWrapper = G;
						...
						for (q(B, H); z < B.length; z++) {
							...
							if (C = D.isLineBreak) {
								...
								if (D.hasBlockSibling) C = 1;
									...
									P = C.startContainer.getAscendant(h.$block, 1);
									if (!P || !P.is({
										div: 1,
										p: 1
									})) C = 0;
							...
							if (C) E = z > 0;
								...
								C = H.startPath();
								if (!D.isBlock && g(n.editor, C.block, C.blockLimit) && (S = n.editor.activeEnterMode != CKEDITOR.ENTER_BR && n.editor.config.autoParagraph !== false ? n.editor.activeEnterMode == CKEDITOR.ENTER_DIV ? "div": "p": false)) {
									S = w.createElement(S);
									S.appendBogus();
									H.insertNode(S);
									CKEDITOR.env.needsBrFiller && (K = S.getBogus()) && K.remove();
									H.moveToPosition(S, CKEDITOR.POSITION_BEFORE_END)
								}
								if ((C = H.startPath().block) && !C.equals(I)) {
									if (K = C.getBogus()) {
										K.remove();
										G.push(C)
									}
								...
								D.firstNotAllowed && (t = 1);
								if (t && D.isElement) {
									C = H.startContainer;
									for (L = null; C && !h[C.getName()][D.name];) {
										if (C.equals(u)) {
											C = null;
											break
										}
									...
									if (C) {
										...
										C = z == B.length - 1;
										L = d(D.node, L);
										for (var P = [], Y = L.length, Z = 0, $ = void 0, X = 0, W = -1; Z < Y; Z++) {
											$ = L[Z];
											if ($ == " ") {
												if (!X && (!V || Z)) {
								...
								if (V) {
									for (; C = V.pop();) H.insertNode(C);
									V = 0
								} else H.insertNode(D.node);
					...
					for (V = K.createBookmark(); I = n.zombies.pop();) if (I.getParent()) {
						S = K.clone();
						S.moveToElementEditStart(I);
						S.removeEmptyBlocksAtEnd()
					}
					if (U) for (; I = U.pop();) CKEDITOR.env.needsBrFiller ? I.appendBogus() : I.append(K.document.createText(" "));
					for (; I = n.mergeCandidates.pop();) I.mergeSiblings();
					K.moveToBookmark(V);
					if (!n.dontMoveCaret) {
		...
		w = function() {
			...
			return function(d) {
				...
				if (f.is("table")) {
					...
					f.is("tr") && (f = b(f, f.getParent().is("thead") ? "th": "td", g)); (e = f.getBogus()) && e.remove();
		...
		function e() {
			...
			if (!u) {
				b.call(this);
				u = CKEDITOR.tools.setTimeout(b, 200, this)
			}
		}
		function b() {
			u = null;
		...
		function c(a) {
			...
			d = a.getPreviousNode(y, null, c),
			e = a.getNextNode(y, null, c);
		...
		var u, t, y = CKEDITOR.dom.walker.invisible(1),
		n = function() {
			function a(b) {
				return function(a) {
		...
		function(b) {
			...
			function() {
				function b() {
					A = new CKEDITOR.dom.selection(f.getSelection());
					A.lock()
				}
				function c() {
					...
					b = a.createRange();
					a.type != "None" && b.parentElement().ownerDocument == i.$ && b.select()
				}
				var i = f.document,
				k = CKEDITOR.document,
				g = f.editable(),
				...
				function(a) {
					a.removeListener();
					if (p !== 0) if ((a = f.getSelection().getNative()) && a.isCollapsed && a.anchorNode == g.$) {
						a = f.createRange();
				...
				null, null, -2);
				g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusIn": "focus",
				function() {
					p && CKEDITOR.env.webkit && (p = f._.previousActive && f._.previousActive.equals(i.getActive()));
					f.unlockSelection(p);
					p = 0
				},
				null, null, -1);
				...
				if (CKEDITOR.env.ie || m) {
					w ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(f, "selectionCheck", b, null, null, -1);
					g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut": "blur",
					function() {
						f.lockSelection(A);
						p = 1
					},
				...
				if (CKEDITOR.env.ie && !m) {
					...
					function(a) {
						if (a.data.$.button == 2 && E) {
							f.document.$.documentElement.scrollLeft = E.x;
							f.document.$.documentElement.scrollTop = E.y
						}
						E = null
					});
					if (i.$.compatMode != "BackCompat") {
						if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) n.on("mousedown",
						function(a) {
							function b(a) {
								a = a.data.$;
								if (d) {
						...
						if (CKEDITOR.env.version > 7 && CKEDITOR.env.version < 11) n.on("mousedown",
						function(a) {
				...
				if (m && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
					...
					g.attachListener(i.getDocumentElement(), "mouseup",
					function() {
						v && e.call(f);
						v = 0
					})
				} else g.attachListener(CKEDITOR.env.ie ? g: i.getDocumentElement(), "mouseup", e, f);
				CKEDITOR.env.webkit && g.attachListener(i, "keydown",
				function(a) {
		...
		function(a) {
			function b() {
				var a = e.editable();
				if (a) if (a = f(a)) {
					var c = e.document.$.defaultView.getSelection();
			...
			function c() {
				...
				if (a) if (a = f(a)) {
					a.setText(h);
					if (j) {
						e.document.$.defaultView.getSelection().setPosition(a.$, a.getLength());
						j = 0
					}
				}
			}
			...
			if (CKEDITOR.env.webkit) {
				...
				function() {
					var a = e.editable(),
					b = f(a);
					b && (b.getCustomData("ready") ? d(a) : b.setCustomData("ready", 1))
				},
				null, null, -1);
				e.on("beforeSetMode",
				function() {
		...
		CKEDITOR.dom.selection = function(a) {
			...
			c = w ? this.document.$.selection: this.document.getWindow().$.getSelection();
			if (CKEDITOR.env.webkit)(c.type == "None" && this.document.getActive().equals(a) || c.type == "Caret" && c.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && h(a, c);
				...
				if (w) c.type == "None" && (b && b.equals(this.document.getDocumentElement())) && h(a, null, true);
					...
					b && (b.equals(this.document.getDocumentElement()) && c && (a.equals(c) || a.contains(c))) && h(a, null, true)
				}
			}
		...
		CKEDITOR.dom.selection.prototype = {
			...
			getRanges: function() {
				...
				function() {
					...
					var b = function(b, c) {
						...
						f, i, g = b.duplicate(), l = 0, h = e.length - 1, A = -1, j, v; l <= h;) {
							A = Math.floor((l + h) / 2);
							f = e[A];
							g.moveToElementText(f);
							j = g.compareEndPoints("StartToStart", b);
							if (j > 0) h = A - 1;
							else if (j < 0) l = A + 1;
							else return {
								container: d,
						...
						g.collapse(j > 0 ? true: false);
						g.setEndPoint(j > 0 ? "StartToStart": "EndToStart", b);
						g = g.text.replace(/(\r\n|\r)/g, "\n").length;
						if (!g) return {
							container: d,
							offset: a(f) + (j > 0 ? 0 : 1)
						...
						return {
							container: v,
							offset: j > 0 ? -g: v.nodeValue.length + g
						}
					};
					return function() {
						var a = this.getNative(),
						...
						if (d == CKEDITOR.SELECTION_ELEMENT) {
							for (var d = [], e = 0; e < c.length; e++) {
								for (var f = c.item(e), g = f.parentNode, i = 0, a = new CKEDITOR.dom.range(this.root); i < g.childNodes.length && g.childNodes[i] != f; i++);
				...
				return function(b) {
					...
					return ! b ? d: p(new CKEDITOR.dom.rangeList(d.slice()))
				}
			} (),
			...
			selectRanges: function(a) {
				...
				if (a.length) if (this.isLocked) {
					...
					a: {
						var j, n;
						if (a.length == 1 && !(n = a[0]).collapsed && (h = n.getEnclosedNode()) && h.type == CKEDITOR.NODE_ELEMENT) {
							n = n.clone();
					...
					if (h) this.fake(h);
						...
						if (w) {
							...
							var a = h.collapsed,
							m, p, o;
							if ((e = h.getEnclosedNode()) && e.type == CKEDITOR.NODE_ELEMENT && e.getName() in r && (!e.is("a") || !e.getText())) try {
								o = e.$.createControlRange();
								o.addElement(e.$);
								o.select();
								return
							} catch(t) {}
							...
							if (g) {
								j = h.document.$.body.createTextRange();
								...
								p.setHtml("&#65279;");
								p.insertBefore(b);
								m && h.document.createText("﻿").insertBefore(b)
							}
							h.setStartBefore(b);
							b.remove();
							if (a) {
							...
							for (o = 0; o < a.length; o++) {
								if (o < a.length - 1) {
									...
									if (!j.collapsed) {
										...
										if (h.isReadOnly() || j && j.isReadOnly()) {
											p.setStart(m.startContainer, m.startOffset);
											a.splice(o--, 1);
											continue
										}
									}
								...
								if (h.collapsed && CKEDITOR.env.webkit && c(h)) {
									...
									h.insertNode(j);
									if ((m = j.getNext()) && !j.getPrevious() && m.type == CKEDITOR.NODE_ELEMENT && m.getName() == "br") {
										d(this.root);
										h.moveToPosition(m, CKEDITOR.POSITION_BEFORE_START)
									} else h.moveToPosition(j, CKEDITOR.POSITION_AFTER_END)
								}
								p.setStart(h.startContainer.$, h.startOffset);
								try {
									p.setEnd(h.endContainer.$, h.endOffset)
								} catch(A) {
									if (A.toString().indexOf("NS_ERROR_ILLEGAL_VALUE") >= 0) {
										h.collapse(1);
										p.setEnd(h.endContainer.$, h.endOffset)
									} else throw A;
								}
	...
	CKEDITOR.STYLE_OBJECT = 3; (function() {
			...
			if (b.collapsed) {
				...
				for (p.getPosition(m) == CKEDITOR.POSITION_FOLLOWING && (p = 0); p;) {
					...
					if (p.equals(m)) {
						...
						var r = p.type == CKEDITOR.NODE_ELEMENT ? p.getName() : null,
						t = r && p.getAttribute("contentEditable") == "false",
						u = r && p.getAttribute("data-nostyle");
						if (r && p.data("cke-bookmark")) {
							p = p.getNextSourceNode(true);
							continue
						}
						if (t && i && CKEDITOR.dtd.$block[r]) for (var s = p,
						w = c(s), x = void 0, F = w.length, M = 0, s = F && new CKEDITOR.dom.range(s.getDocument()); M < F; ++M) {
							var x = w[M],
							X = CKEDITOR.filter.instances[x.data("cke-filter")];
							if (X ? X.check(this) : 1) {
								s.selectNodeContents(x);
								e.call(this, s)
							}
						}
						w = r ? !k[r] || u ? 0 : t && !i ? 0 : (p.getPosition(m) | Q) == Q && (!g.childRule || g.childRule(p)) : 1;
						if (w) if ((w = p.getParent()) && ((w.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(w))) {
							if (!q && (!r || !CKEDITOR.dtd.$removeEmpty[r] || (p.getPosition(m) | Q) == Q)) {
								q = b.clone();
								q.setStartBefore(p)
							}
							r = p.type;
							if (r == CKEDITOR.NODE_TEXT || t || r == CKEDITOR.NODE_ELEMENT && !p.getChildCount()) {
								for (var r = p,
								W; (j = !r.getNext(N)) && (W = r.getParent(), k[W.getName()]) && (W.getPosition(l) | J) == J && (!g.childRule || g.childRule(W));) r = W;
								q.setEndAfter(r)
							}
						} else j = true;
						else j = true;
						p = p.getNextSourceNode(u || t)
					}
					if (j && q && !q.collapsed) {
						for (var j = o(this, d), t = j.hasAttributes(), u = q.getCommonAncestor(), r = {},
						w = {},
						x = {},
						F = {},
						O, T, R; j && u;) {
							if (u.getName() == f) {
								for (O in g.attributes) if (!F[O] && (R = u.getAttribute(T))) j.getAttribute(O) == R ? w[O] = 1 : F[O] = 1;
								for (T in g.styles) if (!x[T] && (R = u.getStyle(T))) j.getStyle(T) == R ? r[T] = 1 : x[T] = 1
							}
							u = u.getParent()
						}
						for (O in w) j.removeAttribute(O);
		...
		function b(a) {
			function b() {
				for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(i.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) {
					var h = a.elements[g];
					if (h == a.block || h == a.blockLimit) break;
					p.checkElementRemovable(h) && (e = h)
				}
				for (g = 0; g < c.elements.length; g++) {
					h = c.elements[g];
					if (h == c.block || h == c.blockLimit) break;
					p.checkElementRemovable(h) && (f = h)
				}
				f && i.breakParent(f);
				e && d.breakParent(e)
			}
			...
			if (a.collapsed) {
				for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, g = 0, h; g < e.elements.length && (h = e.elements[g]); g++) {
					...
					if (this.checkElementRemovable(h)) {
						var j;
						if (a.collapsed && (a.checkBoundaryOfElement(h, CKEDITOR.END) || (j = a.checkBoundaryOfElement(h, CKEDITOR.START)))) {
							f = h;
							f.match = j ? "start": "end"
						} else {
							h.mergeSiblings();
							h.is(this.element) ? t.call(this, h) : n(h, k(this)[h.getName()])
						}
					}
				}
				if (f) {
				...
				for (e = d; ! e.equals(i);) {
					...
					if (e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e)) {
						e.getName() == this.element ? t.call(this, e) : n(e, k(this)[e.getName()]);
		...
		function f(a) {
			var b = a.getEnclosedNode() || a.getCommonAncestor(false, true); (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) && !a.isReadOnly() && r(a, this)
		}
		function d(a) {
		...
		function h(a) {
			...
			for (var d, e; d = c.getNextParagraph();) if (this.checkElementRemovable(d)) if (d.is("pre")) { (e = this._.enterMode == CKEDITOR.ENTER_BR ? null: a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p": "div")) && d.copyAttributes(e);
				m(d, e)
			} else t.call(this, d);
			a.moveToBookmark(b)
		}
		function m(a, b) {
			...
			if (d && !e) {
				...
				b = e
			} else f ? b = u(c ? [a.getHtml()] : j(a), b) : a.moveChildren(b);
			b.replace(a);
			if (d) {
				var c = b,
				h;
		...
		function t(a, b) {
			...
			n(a, e, x[a.getName()]);
			f && (this._.definition.alwaysRemoveElement ? w(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? w(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p": "div"))
		}
		function y(a) {
			for (var b = k(this), c = a.getElementsByTag(this.element), d, e = c.count(); --e >= 0;) {
				d = c.getItem(e);
				d.isReadOnly() || t.call(this, d, true)
			}
			for (var f in b) if (f != this.element) {
				c = a.getElementsByTag(f);
				for (e = c.count() - 1; e >= 0; e--) {
					d = c.getItem(e);
					d.isReadOnly() || n(d, b[f])
				}
			}
		}
		function n(a, b, c) {
			if (b = b && b.attributes) for (var d = 0; d < b.length; d++) {
				...
				if (f = a.getAttribute(e)) {
					var g = b[d][1]; (g === null || g.test && g.test(f) || typeof g == "string" && f == g) && a.removeAttribute(e)
				}
			}
			c || w(a)
		}
		...
		function i(a, b) {
			for (var c in a) a[c] = a[c].replace(R,
			function(a, c) {
				return b[c]
			})
		}
		...
		function q(a, b, c) {
			for (var d = a.document,
			e = a.getRanges(), b = b ? this.removeFromRange: this.applyToRange, f, g = e.createIterator(); f = g.getNextRange();) b.call(this, f, c);
			a.selectRanges(e);
		...
		M = /\s*(?:;\s*|$)/,
		R = /#\((.+?)\)/g,
		N = CKEDITOR.dom.walker.bookmark(0, 1),
		...
		CKEDITOR.style.prototype = {
			apply: function(a) {
				if (a instanceof CKEDITOR.dom.document) return q.call(this, a.getSelection());
			...
			remove: function(a) {
				if (a instanceof CKEDITOR.dom.document) return q.call(this, a.getSelection(), 1);
				if (this.checkApplicable(a.elementPath(), a)) {
					var b = this._.enterMode;
					if (!b) this._.enterMode = a.activeEnterMode;
			...
			removeFromRange: function(a) {
				this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? b: this.type == CKEDITOR.STYLE_BLOCK ? h: this.type == CKEDITOR.STYLE_OBJECT ? d: null;
			...
			if (!b) {
				...
				function(a) {
					for (var e = 0; e < b.length; e++) {
						var d = b[e],
						g = d.style.checkActive(a.data.path, this) ? CKEDITOR.TRISTATE_ON: CKEDITOR.TRISTATE_OFF;
						d.fn.call(this, g)
					}
				})
			}
	...
	"use strict"; (function() {
		...
		CKEDITOR.dom.elementPath = function(b, f) {
			...
			if (m.type == CKEDITOR.NODE_ELEMENT) {
				...
				if (!this.lastElement) {
					this.lastElement = m;
					if (m.is(CKEDITOR.dtd.$object) || m.getAttribute("contenteditable") == "false") continue
				}
				if (m.equals(f)) break;
				if (!g) {
					j = m.getName();
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
		...
		function a(a, c, e) {
			...
			g = c[e ? "endContainer": "startContainer"],
			h = e ? "endOffset": "startOffset",
			m = d ? c.document.getById(a.startNode) : a.startNode,
			a = d ? c.document.getById(a.endNode) : a.endNode;
			if (g.equals(m.getPrevious())) {
			...
			g.equals(m.getParent()) && c[h]++;
			g.equals(a.getParent()) && c[h]++;
			c[e ? "endContainer": "startContainer"] = g;
			return c
		}
			...
			createIterator: function() {
				...
				return {
					getNextRange: function(g) {
						...
						var h = a[d];
						if (h && a.length > 1) {
							if (!d) for (var m = a.length - 1; m >= 0; m--) e.unshift(a[m].createBookmark(true));
							if (g) for (var j = 0; a[d + j + 1];) {
								for (var p = h.document,
								g = 0,
								m = p.getById(e[j].endNode), p = p.getById(e[j + 1].startNode);;) {
							...
							for (h.moveToBookmark(e.shift()); j--;) {
								m = a[++d];
								m.moveToBookmark(e.shift());
								h.setEnd(m.endContainer, m.endOffset)
							}
						}
						return h
					}
...
*/
		...
		onLoad: function() {
			...
			CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {
				labeledElement: function(b, a, d, f) {
					if (! (4 > arguments.length)) {
						...
						CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "div", null, e,
						function() {
							var e = [],
				...
				select: function(b, a, d) {
					if (! (3 > arguments.length)) {
						...
						function() {
							...
							p(c);
							for (var i = 0,
							j; i < a.items.length && (j = a.items[i]); i++) d.push('<option value="', CKEDITOR.tools.htmlEncode(j[1] !== void 0 ? j[1] : j[0]).replace(/"/g, "&quot;"), '" /> ', CKEDITOR.tools.htmlEncode(j[0]));
							if (typeof c.inputStyle != "undefined") c.style = c.inputStyle;
				...
				html: function() {
					...
					return function(f, c, e) {
						if (! (3 > arguments.length)) {
							...
							if (i) {
								var j = this.focus;
								this.focus = function() { ("function" == typeof i ? i: j).call(this);
									this.fire("focus")
								};
				...
				fieldset: function(b, a, d, f, c) {
					...
					CKEDITOR.ui.dialog.uiElement.call(this, b, c, f, "fieldset", null, null,
					function() {
						var a = [];
			...
			CKEDITOR.ui.dialog.radio.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement, {
				setValue: function(b, a) {
					...
					f, c = 0; c < d.length && (f = d[c]); c++) f.getElement().$.checked = f.getValue() == b; ! a && this.fire("change", {
						value: b
					})
				},
				getValue: function() {
			...
			CKEDITOR.dialog.addUIElement("fieldset", {
				build: function(b, a, d) {
					for (var f = a.children,
					c, e = [], h = [], g = 0; g < f.length && (c = f[g]); g++) {
						var i = [];
						e.push(i);
	...
	CKEDITOR.DIALOG_RESIZE_BOTH = 3; (function() {
		...
		CKEDITOR.dialog = function(a, b) {
			...
			function d(b) {
				if (l == CKEDITOR.dialog._.currentTop) {
					...
					l._.tabBarMode ? (c = c ? t.call(l) : u.call(l), l.selectPage(c), l._.tabs[c][0].focus()) : e(c ? -1 : 1),
					o = 1;
					else if (c == CKEDITOR.ALT + 121 && !l._.tabBarMode && 1 < l.getPageCount()) l._.tabBarMode = !0,
					l._.tabs[l._.currentTabId][0].focus(),
					o = 1;
					else if ((37 == c || 39 == c) && l._.tabBarMode) c = c == (d ? 39 : 37) ? t.call(l) : u.call(l),
					l.selectPage(c),
					l._.tabs[c][0].focus(),
					o = 1;
			...
			i = {},
			o,
			j; ("OS" == m && CKEDITOR.env.mac || "rtl" == m && "ltr" == k || "ltr" == m && "rtl" == k) && h.buttons.reverse();
			...
			this.on("iframeAdded",
			function(a) { (new CKEDITOR.dom.document(a.data.iframe.$.contentWindow.document)).on("keydown", d, this, null, 0)
			});
			this.on("show",
			function() {
				c();
		...
		CKEDITOR.dialog.prototype = {
			...
			addPage: function(a) {
				if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
					...
					b), d = this._.contents[a.id] = {},
					g = e.getChild(), f = 0; e = g.shift();) ! e.notAllowed && ("hbox" != e.type && "vbox" != e.type) && f++,
					d[e.id] = e,
					"function" == typeof e.getChild && g.push.apply(g, e.getChild());
					f || (a.hidden = !0);
		...
		z = function(a, b, c) {
			for (var e = 0,
			d; d = a[e]; e++) if (d.id == b || c && d[c] && (d = z(d[c], b, c))) return d;
			return null
		},
		...
		O = function(a, b, c, e, d) { (s[c] || (s[c] = [])).push({
				uiElement: a,
				dialog: b,
				key: c,
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			openDialog: function(a, b) {
				...
				c.show();
					...
					if ("failed" == e) throw K(this),
					Error('[CKEDITOR.dialog.openDialog] Dialog "' + a + '" failed when loading definition.');
					"string" == typeof e && CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(e),
					function() {
	...
	CKEDITOR.config.coreStyles_superscript = {
		...
		function v(b) {
			function a() {
				var e = b.editable();
				e.on(p,
				function(b) { (!CKEDITOR.env.ie || !n) && u(b)
				});
				CKEDITOR.env.ie && e.on("paste",
				function(e) {
					q || (g(), e.data.preventDefault(), u(e), h("paste") || b.openDialog("paste"))
				});
				CKEDITOR.env.ie && (e.on("contextmenu", i, null, null, 0), e.on("beforepaste",
				function(b) {
				...
				var a;
				e.attachListener(CKEDITOR.env.ie ? e: b.document.getDocumentElement(), "mouseup",
				function() {
			...
			function h(e) {
				...
				d.on(e, j); (7 < CKEDITOR.env.version ? a.$: a.$.selection.createRange()).execCommand(e);
			...
			function o(a) {
				...
				case CKEDITOR.CTRL + 86 : case CKEDITOR.SHIFT + 45 : a = b.editable();
					g(); ! CKEDITOR.env.ie && a.fire("beforepaste");
					break;
			...
			q = 0,
			t = 0,
			p = CKEDITOR.env.ie ? "beforepaste": "paste"; (function() {
				b.on("key", o);
				b.on("contentDom", a);
			...
			b.getClipboardData = function(a, d) {
				...
				null, null, 1E3); ! 1 === s() && (b.removeListener("paste", c), g && b.fire("pasteDialog", l) ? (b.on("pasteDialogCommit", j), b.on("dialogHide",
				function(a) {
					a.removeListener();
		...
		function x(b, a) {
			...
			if (a.match(/^[^<]$/)) return a;
			CKEDITOR.env.webkit && -1 < a.indexOf("<div>") && (a = a.replace(/^(<div>(<br>|)<\/div>)(?!$|(<div>(<br>|)<\/div>))/g, "<br>").replace(/^(<div>(<br>|)<\/div>){2}(?!$)/g, "<div></div>"), a.match(/<div>(<br>|)<\/div>/) && (a = "<p>" + a.replace(/(<div>(<br>|)<\/div>)+/g,
			function(a) {
				return c(a.split("</div><div>").length + 1)
			}) + "</p>"), a = a.replace(/<\/div><div>/g, "<br>"), a = a.replace(/<\/?div>/g, ""));
			CKEDITOR.env.gecko && b.enterMode != CKEDITOR.ENTER_BR && (CKEDITOR.env.gecko && (a = a.replace(/^<br><br>$/, "<br>")), -1 < a.indexOf("<br><br>") && (a = "<p>" + a.replace(/(<br>){2,}/g,
			function(a) {
				return c(a.length / 4)
			}) + "</p>"));
			return o(b, a)
		...
		function o(b, a) {
			b.enterMode == CKEDITOR.ENTER_BR ? a = a.replace(/(<\/p><p>)+/g,
			function(a) {
		...
		CKEDITOR.plugins.add("clipboard", {
			...
			init: function(b) {
				...
				function(a) {
					...
					g = CKEDITOR.dtd.$block; - 1 < b.indexOf("Apple-") && (b = b.replace(/<span class="Apple-converted-space">&nbsp;<\/span>/gi, " "), "html" != a.data.type && (b = b.replace(/<span class="Apple-tab-span"[^>]*>([^<]*)<\/span>/gi,
					function(a, b) {
						return b.replace(/\t/g, "&nbsp;&nbsp; &nbsp;")
		...
		CKEDITOR.ui.button.prototype = {
			render: function(a, b) {
				...
				} else if (f && (f = a.getCommand(f))) f.on("state",
				function() {
					this.setState(f.state)
				},
				this),
				e += f.state == CKEDITOR.TRISTATE_ON ? "on": f.state == CKEDITOR.TRISTATE_DISABLED ? "disabled": "off";
		...
		CKEDITOR.ui.panel.block = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				onKeyDown: function(a, b) {
					...
					switch (d) {
					case "next":
						for (var e = this._.focusIndex,
						d = this.element.getElementsByTag("a"), c; c = d.getItem(++e);) if (c.getAttribute("_cke_focus") && c.$.offsetWidth) {
							this._.focusIndex = e;
							c.focus();
							break
						}
					...
					case "click":
					case "mouseup":
						return e = this._.focusIndex,
						(c = 0 <= e && this.element.getElementsByTag("a").getItem(e)) && (c.$[d] ? c.$[d]() : c.$["on" + d]()),
						!1
					}
					return ! 0
				}
		...
		CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				showBlock: function(a, b, c, i, f, h) {
					...
					this), CKEDITOR.env.iOS && (a.on("touchstart",
					function() {
					...
					CKEDITOR.tools.setTimeout(function() {
						var a = CKEDITOR.tools.bind(function() {
							...
							var a = d.getFirst(),
							n; (n = a.getCustomData("activePanel")) && n.onHide && n.onHide.call(this, 1);
	...
	CKEDITOR.plugins.add("menu", {
		...
		beforeInit: function(g) {
			for (var h = g.config.menu_groups.split(","), m = g._.menuGroups = {},
			l = g._.menuItems = {},
	...
	CKEDITOR.plugins.add("resize", {
			...
			function d() {
				for (var b = g(), e = CKEDITOR.tools.clone(a.config.toolbarGroups) || n(a), f = 0; f < e.length; f++) {
					...
					if ("/" != k) {
						...
						var i, d = k.groups;
						if (d) for (var h = 0; h < d.length; h++) i = d[h],
						(i = b[i]) && c(k, i); (i = b[k.name]) && c(k, i)
					}
				}
				return e
			}
		...
		u.prototype.focus = function() {
			for (var a = 0,
			d; d = this.toolbars[a++];) for (var g = 0,
			c; c = d.items[g++];) if (c.focus) {
				c.focus();
				return
			}
		};
			...
			init: function(a) {
				var d, g = function(c, h) {
					...
					case o:
						b = c;
						do b = b.next,
						!b && j && (b = c.toolbar.items[0]);
						while (b && !b.focus);
						b ? b.focus() : g(c, 9);
						return ! 1;
					case 40:
						return c.button && c.button.hasArrow ? (a.once("panelShow",
						function(b) {
							b.data._.panel._.currentBlock.onKeyDown(40)
						}), c.execute()) : g(c, 40 == h ? o: e),
						!1;
					case e:
					case 38:
						b = c;
						do b = b.previous,
						!b && j && (b = c.toolbar.items[c.toolbar.items.length - 1]);
						while (b && !b.focus);
		...
		function n(a, c) {
			...
			u = CKEDITOR.tools.addFunction(function(d, e) {
				...
				case b ? 39 : 37 : case 9:
					...
					b.focus(),
					!1;
				case b ? 37 : 39 : case CKEDITOR.SHIFT + 9 : return (b = CKEDITOR.document.getById(g + (d - 1))) || (b = CKEDITOR.document.getById(g + (i.list.length - 1))),
					b.focus(),
					!1;
				case 27:
					return a.focus(),
			...
			function() {
				...
				for (var d = [], e = i.list = [], g = [], b = i.filters, c = !0, j = a.elementPath().elements, f, k = j.length; k--;) {
					...
					c = h.hasAttribute("contenteditable") ? "true" == h.getAttribute("contenteditable") : c; ! c && !h.hasAttribute("contenteditable") && (p = 1);
				...
				e = e.length;
				for (b = 0; b < e; b++) f = g[b],
				c = a.lang.elementspath.eleTitle.replace(/%1/, f),
				f = v.output({
					id: n + b,
					label: c,
					text: f,
		...
		CKEDITOR.plugins.enterkey = {
			enterBlock: function(b, d, a, h) {
				if (a = a || r(b)) {
					...
					if (i && k) {
						if (c && (c.is("li") || c.getParent().is("li"))) {
							...
							if (e.is("li")) if (h || n) c[h ? "insertBefore": "insertAfter"](e);
								...
								if (b) if (j.block.is("li") ? (e = f.createElement(d == CKEDITOR.ENTER_P ? "p": "div"), m && e.setAttribute("dir", i), o && e.setAttribute("style", o), k && e.setAttribute("class", k), c.moveChildren(e)) : e = j.block, h || n) e[h ? "insertBefore": "insertAfter"](a);
								else c.breakParent(a),
								e.insertAfter(a);
								else if (c.appendBogus(!0), h || n) for (; f = c[h ? "getFirst": "getLast"]();) f[h ? "insertBefore": "insertAfter"](a);
					...
					if (i = a.splitBlock(l)) {
						...
						else if (d && (g = d.getParent()) && g.is("li")) d.breakParent(g),
						g = d.getNext(),
						a.moveToElementEditStart(g),
						...
						c && a.moveToElementEditStart(c);
							...
							if (CKEDITOR.env.ie && j && (!b || !d.getChildCount())) a.moveToElementEditStart(b ? d: e),
							a.select();
			...
			enterBr: function(b, d, a, h) {
				if (a = a || r(b)) {
					...
					j = k.block,
					c = j && k.block.getName(); ! h && "li" == c ? q(b, d, a, h) : (!h && i && s.test(c) ? (i = j.getDirection()) ? (f = f.createElement("div"), f.setAttribute("dir", i), f.insertAfter(j), a.setStart(f, 0)) : (f.createElement("br").insertAfter(j), CKEDITOR.env.gecko && f.createText("").insertAfter(j), a.setStartAt(j.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START: CKEDITOR.POSITION_AFTER_START)) : (b = "pre" == c && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? f.createText("\r") : f.createElement("br"), a.deleteContents(), a.insertNode(b), CKEDITOR.env.needsBrFiller ? (f.createText("﻿").insertAfter(b), i && (j || k.blockLimit).appendBogus(), b.getNext().$.nodeValue = "", a.setStartAt(b.getNext(), CKEDITOR.POSITION_AFTER_START)) : a.setStartAt(b, CKEDITOR.POSITION_AFTER_END)), a.collapse(!0), a.select(), a.scrollIntoView())
				}
			}
		};
	...
	CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
		...
		function(a) {
			if (a.editor.plugins.filebrowser) for (var c = a.data.definition,
	...
	CKEDITOR.config.find_highlight = {
		...
		CKEDITOR.plugins.add("fakeobjects", {
			...
			afterInit: function(a) { (a = (a = a.dataProcessor) && a.htmlFilter) && a.addRules(k, {
					applyToAll: !0
				})
			}
		});
	...
	CKEDITOR.plugins.add("richcombo", {
		...
		CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				render: function(a, b) {
					...
					a.on("activeFilterChange", g, this);
					a.on("mode", g, this);
					a.on("selectionChange", g, this); ! this.readOnly && a.on("readOnly", g, this);
					var k = CKEDITOR.tools.addFunction(function(b, d) {
						var b = new CKEDITOR.dom.event(b),
						g = b.getKeystroke();
						if (40 == g) a.once("panelShow",
						function(a) {
		...
		function e(b, a, e, h, j, n, l, o) {
			for (var p = b.config,
			k = new CKEDITOR.style(l), c = j.split(";"), j = [], g = {},
			d = 0; d < c.length; d++) {
				var f = c[d];
				if (f) {
					var f = f.split("/"),
	...
	CKEDITOR.plugins.add("forms", {
		...
		init: function(a) {
			...
			f = this.path + "dialogs/"; ! a.blockless && e("Form", "form", f + "form.js");
			...
			function(d) {
				...
				else if (c.is("img") && c.data("cke-real-element-type") == "hiddenfield") d.data.dialog = "hiddenfield";
				else if (c.is("input")) {
	...
	CKEDITOR.plugins.add("format", {
		...
		init: function(a) {
			if (!a.blockless) {
				for (var f = a.config,
				c = a.lang.format,
				j = f.format_tags.split(";"), d = {},
				k = 0, l = [], g = 0; g < j.length; g++) {
					var h = j[g],
					i = new CKEDITOR.style(f["format_" + h]);
					if (!a.filter.customConfig || a.filter.check(i)) k++,
					d[h] = i,
	...
	CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
		...
		function k(a) {
			...
			b = a.document,
			c = b.body,
			d = b.getElementById("cke_actscrpt");
			d && d.parentNode.removeChild(d); (d = b.getElementById("cke_shimscrpt")) && d.parentNode.removeChild(d); (d = b.getElementById("cke_basetagscrpt")) && d.parentNode.removeChild(d);
			...
			this.setup();
			CKEDITOR.env.ie && (b.getDocumentElement().addClass(b.$.compatMode), e.config.enterMode != CKEDITOR.ENTER_P && this.attachListener(b, "selectionchange",
			function() {
				var a = b.getBody(),
				c = e.getSelection(),
				d = c && c.getRanges()[0];
			...
			if (CKEDITOR.env.webkit || CKEDITOR.env.ie && 10 < CKEDITOR.env.version) b.getDocumentElement().on("mousedown",
			function(a) {
			...
			} catch(g) {} (CKEDITOR.env.gecko || CKEDITOR.env.ie && "CSS1Compat" == e.document.$.compatMode) && this.attachListener(this, "keydown",
			function(a) {
				var b = a.data.getKeystroke();
			...
			CKEDITOR.env.iOS && this.attachListener(b, "touchend",
			function() {
				a.focus()
			});
		...
		var j = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				detach: function() {
					...
					a.clearCustomData();
					CKEDITOR.tools.removeFunction(this._.frameLoadedHandler); (e = a.removeCustomData("onResize")) && e.removeListener();
					a.remove()
				}
			}
		})
	...
	CKEDITOR.config.contentsCss = CKEDITOR.getUrl("contents.css"); (function() {
		function e(b, a) {
	...
	CKEDITOR.config.image_removeLinkByEmptyURL = !0; (function() {
		...
		function s(e) {
			...
			o = this.database,
			k = this.context,
			l = e.getSelection(), l = (l && l.getRanges()).createIterator(), d; d = l.getNextRange();) {
	...
	CKEDITOR.UI_MENUBUTTON = "menubutton"; (function() {
		CKEDITOR.plugins.add("language", {
			...
			init: function(a) {
				...
				for (f = 0; f < b.length; f++) g = b[f].split(":"),
				h = g[0],
				i = "language_" + h,
				e[i] = {
					label: g[1],
			...
			getCurrentLangElement: function(a) {
				...
				a = b && b.elements,
				c;
				if (b) for (var d = 0; d < a.length; d++) b = a[d],
				!c && ("span" == b.getName() && b.hasAttribute("dir") && b.hasAttribute("lang")) && (c = b);
				return c
			}
		})
	})(); (function() {
		...
		function n(c) {
			for (var b, a = c.length,
			f = [], e = 0; e < a; e++) b = c.charCodeAt(e),
			f.push(b);
		...
		function o(c, b) {
			...
			for (var g = 0; g < f.length; g++) a = f[g].toLowerCase(),
			e = b[a],
			0 < g && d.push(","),
		...
		CKEDITOR.plugins.link = {
			...
			parseLinkAttributes: function(c, b) {
				...
				d,
				g = {};
				a.match(p) && ("encode" == e ? a = a.replace(w,
				function(a, b, c) {
				...
				function(a, b, c) {
					if (b == f.name) {
						...
						for (var a = g.email = {},
						b = /(^')|('$)/g,
						c = c.match(/[^,\s]+/g), d = c.length, e, h, i = 0; i < d; i++) e = decodeURIComponent,
						h = c[i].replace(b, "").replace(/\\'/g, "'"),
						h = e(h),
						e = f.params[i].toLowerCase(),
						a[e] = h;
						a.address = [a.name, a.domain].join("@")
					}
				}));
				if (!g.type) if (e = a.match(t)) g.type = "anchor",
				g.anchor = {},
				...
				} else if (a && (d = a.match(u))) g.type = "url",
				g.url = {},
				g.url.protocol = d[1],
				g.url.url = d[2];
				if (b) {
		...
		function E(c, j, e) {
			...
			f = null;
			for (h = 0; h < g.length; h++) f = g[h].getCustomData("listarray_index"),
			k[f].indent = -1;
			for (h = f + 1; h < k.length; h++) if (k[h].indent > k[h - 1].indent + 1) {
				g = k[h - 1].indent + 1 - k[h].indent;
				for (f = k[h].indent; k[h] && k[h].indent >= f;) k[h].indent += g,
				h++;
				h--
			}
		...
		function A(c, j, e, b) {
			...
			k.remove(),
			e ? k[b ? "insertBefore": "insertAfter"](e) : j.append(k, b)
		}
		function B(c) {
			var j; (j = function(e) {
		...
		function y(c, j, e) {
			...
			h ? (h = h.getBogus()) && h.remove() : f && (h = f.getPrevious(q)) && v(h) && h.remove(); (h = b.getLast()) && (h.type == CKEDITOR.NODE_ELEMENT && h.is("br")) && h.remove(); (h = j.startContainer.getChild(j.startOffset)) ? b.insertBefore(h) : j.startContainer.append(b);
		...
		CKEDITOR.plugins.list = {
			listToArray: function(c, j, e, b, k) {
				...
				h = c.getChildCount(); g < h; g++) {
					...
					if ("li" == f.$.nodeName.toLowerCase()) {
						...
						e.push(a);
						for (var d = 0,
						m = f.getChildCount(), i; d < m; d++) i = f.getChild(d),
						i.type == CKEDITOR.NODE_ELEMENT && r[i.getName()] ? CKEDITOR.plugins.list.listToArray(i, j, e, b + 1, a.grandparent) : a.contents.push(i)
					}
				}
				return e
			},
			arrayToList: function(c, j, e, b, k) {
				...
				for (var g, h = c[e].parent.getDocument(), f = new CKEDITOR.dom.documentFragment(h), a = null, d = e, m = Math.max(c[e].indent, 0), i = null, n, l, p = b == CKEDITOR.ENTER_P ? "p": "div";;) {
					...
					d = CKEDITOR.plugins.list.arrayToList(c, null, d, b, o != n ? n: null),
					!i.getChildCount() && (CKEDITOR.env.needsNbspFiller && !(7 < h.$.documentMode)) && i.append(h.createText(" ")),
					i.append(d.listNode),
					d = d.nextIndex;
						...
						n = i.$.nodeName.toLowerCase(); ("div" == n || "p" == n) && i.appendBogus();
						f.append(i);
						a = null;
						d++
					} else return null;
		...
		x.prototype = {
			exec: function(c) {
				...
				if (this.state == CKEDITOR.TRISTATE_OFF) {
					var k = c.editable();
					if (k.getFirst(q)) {
						var g = 1 == b.length && b[0]; (j = g && g.getEnclosedNode()) && (j.is && this.type == j.getName()) && this.setState(CKEDITOR.TRISTATE_ON)
					} else j.enterMode == CKEDITOR.ENTER_BR ? k.appendBogus() : b[0].fixBlock(1, j.enterMode == CKEDITOR.ENTER_P ? "p": "div"),
					e.selectRanges(b)
				}
				for (var j = e.createBookmarks(!0), k = [], h = {},
				b = b.createIterator(), f = 0; (g = b.getNextRange()) && ++f;) {
					...
					for (g.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; a = g.getNextParagraph();) if (!a.getCustomData("list_block")) {
						...
						for (var i = c.elementPath(a), d = i.elements, m = 0, i = i.blockLimit, n, l = d.length - 1; 0 <= l && (n = d[l]); l--) if (r[n.getName()] && i.contains(n)) {
							i.removeCustomData("list_group_object_" + f); (d = n.getCustomData("list_group_object")) ? d.contents.push(a) : (d = {
								root: n,
								contents: [a]
							},
				...
				for (n = []; 0 < k.length;) if (d = k.shift(), this.state == CKEDITOR.TRISTATE_OFF) if (r[d.root.getName()]) {
					...
					if (! (1 > f.length)) {
						...
						g.push(l);
						for (p = g = void 0; f.length;) g = f.shift(),
						p = b.createElement("li"),
						g.is("pre") || H.test(g.getName()) || "false" == g.getAttribute("contenteditable") ? g.appendTo(p) : (g.copyAttributes(p), d && g.getDirection() && (p.removeStyle("direction"), p.removeAttribute("dir")), g.moveChildren(p), g.remove()),
						p.appendTo(l);
		...
		function ha(a) {
			...
			b = CKEDITOR.getUrl(this.path + "images/" + (n.hidpi ? "hidpi/": "") + "icon" + (a.rtl ? "-rtl": "") + ".png");
			q(d, {
				attach: function() {
		...
		function $(a) {
			...
			g,
			i;
			if (c.y > e.size.top - 1 && c.y < e.size.top + b) i = !1;
			...
			} else e.equals(a.editable[i ? "getLast": "getFirst"](a.isRelevant)) ? (C(a), i && c.y > e.size.bottom - b && c.y < d.pane.height && e.size.bottom > d.pane.height - b && e.size.bottom < d.pane.height ? g = y: 0 < c.y && c.y < e.size.top + b && (g = x)) : g = s,
			f = [null, e][i ? "reverse": "concat"]().concat([i ? Z: D, H, g, e.equals(a.editable[i ? "getLast": "getFirst"](a.isRelevant)) ? i ? y: x: s]);
		...
		function P(a, c, d, b) {
			...
			} (), f = c.getDocumentPosition(), g = {},
			i = {},
			h = {},
			j = {},
			l = t.length; l--;) g[t[l]] = parseInt(e("border-" + t[l] + "-width"), 10) || 0,
			h[t[l]] = parseInt(e("padding-" + t[l]), 10) || 0,
			i[t[l]] = parseInt(e("margin-" + t[l]), 10) || 0; (!d || b) && I(a, b);
		...
		function la(a, c, d, b) {
			...
			i = !1,
			h = !1,
			j = a.view.pane.height,
			l = a.mouse; l.y + g < j && 0 < l.y - g;) {
				i || (i = c(e, b));
				h || (h = c(f, b)); ! i && 0 < l.y - g && (e = d(a, {
					x: l.x,
					y: l.y - g
				})); ! h && l.y + g < j && (f = d(a, {
					x: l.x,
			...
			init: function(a) {
				...
				function() {
					...
					d.is(w.$inline) || (b.inInlineMode && !X(d) && d.setStyles({
						...
						top: null,
						left: null
					}), ha.call(this, b), I(b), d.attachListener(a, "beforeUndoImage",
					function() {
						b.line.detach()
					}), d.attachListener(a, "beforeGetData",
					function() {
						b.line.wrap.getParent() && (b.line.detach(), a.once("getData",
						function() {
							b.line.attach()
						},
						null, null, 1E3))
					},
					null, null, 0), d.attachListener(b.inInlineMode ? h: h.getWindow().getFrame(), "mouseout",
					function(c) {
						if ("wysiwyg" == a.mode) if (b.inInlineMode) {
							...
							f = b.view.scroll;
							if (! (d > e.left - f.x && d < e.right - f.x) || !(c > e.top - f.y && c < e.bottom - f.y)) clearTimeout(g),
							g = null,
							b.line.detach()
						} else clearTimeout(g),
						g = null,
						b.line.detach()
					}), d.attachListener(d, "keyup",
					function() {
						b.hiddenMode = 0
					}), d.attachListener(d, "keydown",
					function(c) {
					...
					}), d.attachListener(b.inInlineMode ? d: h, "mousemove",
					function(c) {
						f = !0;
						if (! ("wysiwyg" != a.mode || a.readOnly || g)) {
							...
							g = setTimeout(function() {
								...
								g = b.trigger = null;
								I(b);
								if (f && !b.hiddenMode && a.focusManager.hasFocus && !b.line.mouseNear() && (b.element = ca(b, !0)))(b.trigger = Y(b) || $(b) || da(b)) && !W(b, b.trigger.upper || b.trigger.lower) ? b.line.attach().place() : (b.trigger = null, b.line.detach()),
								f = !1
							},
							30)
						}
					}), d.attachListener(j, "scroll",
					function() {
						"wysiwyg" == a.mode && (b.line.detach(), n.webkit && (b.hiddenMode = 1, clearTimeout(e), e = setTimeout(function() {
							b.mouseDown || (b.hiddenMode = 0)
						},
						50)))
					}), d.attachListener(ea ? h: j, "mousedown",
					function() {
						"wysiwyg" == a.mode && (b.line.detach(), b.hiddenMode = 1, b.mouseDown = 1)
					}), d.attachListener(ea ? h: j, "mouseup",
					function() {
						b.hiddenMode = 0;
						b.mouseDown = 0
					}), a.addCommand("accessPreviousSpace", U(b)), a.addCommand("accessNextSpace", U(b, !0)), a.setKeystroke([[c.magicline_keystrokePrevious, "accessPreviousSpace"], [c.magicline_keystrokeNext, "accessNextSpace"]]), a.on("loadSnapshot",
					function() {
						var c, d, e, f;
						for (f in {
							p: 1,
		...
		da = function() {
			function a(a) {
				...
				i, h, j, l; f && !f.equals(e) && (h = e.getNext(a.isRelevant));) i = Math.abs(ga(a, e, h) - a.mouse.y),
				i < b && (b = i, j = e, l = h),
				e = h,
				o(a, e);
	...
	CKEDITOR.plugins.add("newpage", {
		...
		CKEDITOR.plugins.add("pagebreak", {
			...
			init: function(a) {
				a.blockless || (a.addCommand("pagebreak", CKEDITOR.plugins.pagebreakCmd), a.ui.addButton && a.ui.addButton("PageBreak", {
					...
					command: "pagebreak",
					toolbar: "insert,70"
				}), CKEDITOR.env.webkit && a.on("contentDom",
				function() {
					a.document.on("click",
					function(b) {
						b = b.data.getTarget();
		...
		var h, i = {
			...
			exec: function(a) {
				...
				CKEDITOR.env.ie && c && (c.location = e); ! CKEDITOR.env.ie && !CKEDITOR.env.gecko && (e = c.document, e.open(), e.write(a.dataValue), e.close());
				return ! 0
			}
		};
	...
	CKEDITOR.plugins.add("scayt", {
		...
		addMenuItems: function(a) {
			...
			a.plugins.wsc && (b.WSC = {
				...
				onClick: function() {
					...
					b = a.scayt,
					d = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? a.container.getText() : a.document.getBody().getText(); (d = d.replace(/\s/g, "")) ? (b && (c.state[a.name] && b.setMarkupPaused) && b.setMarkupPaused(!0), a.lockSelection(), a.execCommand("checkspell")) : alert("Nothing to check!")
				}
			});
			a.addMenuItems(b)
		},
		bindEvents: function(a) {
			...
			CKEDITOR.on("dialogDefinition",
			function(a) {
				if ("scaytDialog" === a.data.name) a.data.definition.dialog.on("cancel",
				function() {
					return ! 1
				},
				this, null, -1)
			...
			a.on("beforeSetMode",
			function(c) {
				if ("source" == c.data && (c = a.scayt)) d.destroy(a),
				a.fire("scaytButtonState", CKEDITOR.TRISTATE_DISABLED)
			});
			...
			function(c) {
				var b;
				c && (b = a.scayt, !0 === c.editor.readOnly ? b && b.fire("removeMarkupInDocument", {}) : b ? b.fire("startSpellCheck") : "wysiwyg" == c.editor.mode && !0 === d.state[c.editor.name] && (d.createScayt(a), c.editor.fire("scaytButtonState", CKEDITOR.TRISTATE_ON)))
			});
		...
		menuGenerator: function(a, d) {
			...
			for (var e in b) - 1 == CKEDITOR.tools.indexOf(g, e.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || (f[e] = CKEDITOR.TRISTATE_OFF, "function" === typeof b[e].verification && !b[e].verification(a) && delete f[e], a.addCommand(e, {
				exec: b[e].exec
			}), a.addMenuItem(e, {
	...
	CKEDITOR.plugins.scayt = {
		...
		createScayt: function(a) {
			...
			function(a) {
				...
				function() {},
				function() {});
				b.subscribe("suggestionListSend",
				function(a) {
					for (var b = {},
					c = [], d = 0; d < a.suggestionList.length; d++) if (!b[a.suggestionList[d]]) {
	...
	function() {
		...
		if (!0 === CKEDITOR.config.scayt_handleUndoRedo) {
			...
			a[d] = CKEDITOR.tools.override(a[d],
			function(a) {
				return function(b) {
					...
					e = b.contents,
					h = null;
					CKEDITOR.plugins.scayt && (CKEDITOR.plugins.scayt.state[b.editor.name] && b.editor.scayt) && (this.contents = d.removeMarkupFromString(g) || "", b.contents = d.removeMarkupFromString(e) || "");
		...
		CKEDITOR.plugins.add("stylescombo", {
			...
			init: function(c) {
				...
				function(b) {
					if (b = b.data.styles) {
						for (var a, h, d, e = 0,
						l = b.length; e < l; e++) if (a = b[e], !(c.blockless && a.element in CKEDITOR.dtd.$block) && (h = a.name, a = new CKEDITOR.style(a), !c.filter.customConfig || c.filter.check(a))) a._name = h,
						a._.enterMode = j.enterMode,
						a._.type = d = a.assignedTo || a.type,
						a._.weight = e + 1E3 * (d == CKEDITOR.STYLE_OBJECT ? 1 : d == CKEDITOR.STYLE_BLOCK ? 2 : 3),
						f[h] = a,
						i.push(a),
						k.push(a);
						i.sort(function(a, b) {
	...
	CKEDITOR.tools.buildTableMap = function(p) {
		...
		e.prototype = {
			...
			save: function(a, b, c) {
				...
				this.currentImage = b; ! 1 !== c && this.refreshState();
				return ! 0
			},
			...
			getNextImage: function(a) {
				...
				if (c) if (a) for (d = this.index - 1; 0 <= d; d--) {
					if (a = b[d], !c.equalsContent(a)) return a.index = d,
					a
			...
			update: function(a) {
				if (!this.locked) {
					...
					c = this.snapshots; 0 < b && this.currentImage.equalsContent(c[b - 1]);) b -= 1;
		...
		f.prototype = {
			equalsContent: function(a) {
				var b = this.contents,
				a = a.contents;
				if (CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks)) b = b.replace(h, ""),
				a = a.replace(h, "");
				return b != a ? !1 : !0
			},
		...
		i.prototype = {
			onKeydown: function(a) {
				if ( - 1 < CKEDITOR.tools.indexOf(g, a.data.getKeystroke())) a.data.preventDefault();
					...
					if (e.isNavigationKey(a) || this.undoManager.keyGroupChanged(a)) if (b.strokesRecorded[0] || b.strokesRecorded[1]) b.save(!1, this.lastKeydownImage),
					b.resetType()
				}
			},
			onInput: function() {
			...
			attachListeners: function() {
				...
				b.attachListener(b.isInline() ? b: a.document.getDocumentElement(), "click",
				function() {
					c.onNavigationKey()
				},
				null, null, 999);
				b.attachListener(this.undoManager.editor, "blur",
				function() {
	...
	CKEDITOR.plugins.add("wsc", {
		...
		init: function(a) {
			...
			"undefined" == typeof a.plugins.scayt && a.ui.addButton && a.ui.addButton("SpellChecker", {
				label: a.lang.wsc.toolbar,
				click: function(a) {
					var b = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? a.container.getText() : a.document.getBody().getText(); (b = b.replace(/\s/g, "")) ? a.execCommand("checkspell") : alert("Nothing to check!")
				},
